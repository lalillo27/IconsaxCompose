    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 5.13f, b = 5.13f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, dx1 = -3.85f, dy1 = -1.75f)
                moveToRelative(dx = -8.46f, dy = 5.85f)
                arcToRelative(a = 3.08f, b = 3.08f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, dx1 = 3.08f, dy1 = -3.08f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineMiter = 10.0f,
