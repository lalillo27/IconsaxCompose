    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 17.83f, y = 11.75f)
                horizontalLineTo(x = 13.0f)
                arcTo(horizontalEllipseRadius = 0.76f, verticalEllipseRadius = 0.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 12.25f, y1 = 11.0f)
                verticalLineTo(y = 6.17f)
