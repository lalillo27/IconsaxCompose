...
val ScanBarcode: ImageVector
    get() {
        val current = _scanBarcode
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.ScanBarcode",
            ...
            path(
                ...
                curveToRelative(dx1 = -1.14f, dy1 = 0.0f, dx2 = -1.75f, dy2 = 0.6f, dx3 = -1.75f, dy3 = 1.75f)
                verticalLineToRelative(dy = 2.0f)
                curveToRelative(dx1 = 0.0f, dy1 = 1.15f, dx2 = 0.61f, dy2 = 1.75f, dx3 = 1.75f, dy3 = 1.75f)
                horizontalLineToRelative(dx = 2.0f)
                quadToRelative(dx1 = 1.73f, dy1 = -0.01f, dx2 = 1.75f, dy2 = -1.75f)
                verticalLineTo(y = 7.0f)
                quadTo(x1 = 10.73f, y1 = 5.26f, x2 = 9.0f, y2 = 5.25f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
                fillAlpha = 0.4f,
                ...
                moveTo(x = 17.0f, y = 5.25f)
                horizontalLineToRelative(dx = -2.0f)
                quadTo(x1 = 13.27f, y1 = 5.26f, x2 = 13.25f, y2 = 7.0f)
                verticalLineToRelative(dy = 2.0f)
                quadToRelative(dx1 = 0.02f, dy1 = 1.74f, dx2 = 1.75f, dy2 = 1.75f)
                horizontalLineToRelative(dx = 2.0f)
                quadToRelative(dx1 = 1.73f, dy1 = -0.01f, dx2 = 1.75f, dy2 = -1.75f)
                verticalLineTo(y = 7.0f)
                quadTo(x1 = 18.73f, y1 = 5.26f, x2 = 17.0f, y2 = 5.25f)
                ...
                quadToRelative(dx1 = 1.73f, dy1 = -0.01f, dx2 = 1.75f, dy2 = -1.75f)
                verticalLineToRelative(dy = -2.0f)
                quadTo(x1 = 10.73f, y1 = 13.26f, x2 = 9.0f, y2 = 13.25f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
                moveTo(x = 17.0f, y = 13.25f)
                horizontalLineToRelative(dx = -2.0f)
                quadToRelative(dx1 = -1.73f, dy1 = 0.01f, dx2 = -1.75f, dy2 = 1.75f)
                verticalLineToRelative(dy = 2.0f)
                quadToRelative(dx1 = 0.02f, dy1 = 1.74f, dx2 = 1.75f, dy2 = 1.75f)
