    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 17.25f, y = 8.3f)
                arcToRelative(a = 7.9f, b = 7.9f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -10.5f, dy1 = 0.0f)
                lineToRelative(dx = 2.18f, dy = 3.5f)
                arcToRelative(a = 4.6f, b = 4.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 6.14f, dy1 = 0.0f)
            }
