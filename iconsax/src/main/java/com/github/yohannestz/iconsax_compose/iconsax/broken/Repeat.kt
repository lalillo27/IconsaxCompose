    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 3.58f, y = 5.16f)
                horizontalLineToRelative(dx = 9.41f)
                moveTo(x = 6.74f, y = 2.0f)
                lineTo(x = 3.58f, y = 5.16f)
                lineToRelative(dx = 3.16f, dy = 3.16f)
                moveToRelative(dx = 13.68f, dy = 10.52f)
