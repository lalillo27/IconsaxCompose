    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(dx = 2.05f, dy = 4.18f)
                arcToRelative(a = 2.45f, b = 2.45f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 3.54f, dy1 = 1.03f)
                lineToRelative(dx = 6.43f, dy = -3.9f)
                arcToRelative(a = 2.46f, b = 2.46f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.71f, dy1 = -3.63f)
                lineToRelative(dx = -2.77f, dy = -3.74f)
                arcToRelative(a = 3.97f, b = 3.97f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -5.29f, dy1 = -1.04f)
