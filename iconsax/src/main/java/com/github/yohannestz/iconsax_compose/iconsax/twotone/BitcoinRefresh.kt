    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 9.26f, verticalEllipseRadius = 9.26f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 4.77f, y1 = 6.2f)
                moveTo(x = 2.74f, y = 9.69f)
                verticalLineTo(y = 12.0f)
