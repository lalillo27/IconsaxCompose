    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 3.61f, dy = -0.66f)
                lineToRelative(dx = 0.14f, dy = -0.86f)
                curveToRelative(dx1 = 0.1f, dy1 = -0.62f, dx2 = 0.18f, dy2 = -1.09f, dx3 = 1.29f, dy3 = -1.09f)
                horizontalLineToRelative(dx = 1.72f)
                curveToRelative(dx1 = 1.11f, dy1 = 0.0f, dx2 = 1.19f, dy2 = 0.49f, dx3 = 1.29f, dy3 = 1.09f)
                lineToRelative(dx = 0.14f, dy = 0.85f)
