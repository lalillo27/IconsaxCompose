    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 7.27f, y = 13.0f)
                arcToRelative(a = 4.0f, b = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.72f, dy1 = -0.4f)
                ...
                curveToRelative(dx1 = 3.29f, dy1 = -2.87f, dx2 = 1.53f, dy2 = -8.64f, dx3 = -2.8f, dy3 = -9.2f)
                curveTo(x1 = 15.92f, y1 = 0.12f, x2 = 2.39f, y2 = 3.68f, x3 = 5.6f, y3 = 12.6f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
