    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 0.0f, dy1 = -0.66f, dx2 = 0.28f, dy2 = -0.89f, dx3 = 0.94f, dy3 = -0.89f)
                horizontalLineToRelative(dx = 0.47f)
                curveToRelative(dx1 = 0.65f, dy1 = 0.0f, dx2 = 0.94f, dy2 = 0.23f, dx3 = 0.94f, dy3 = 0.89f)
                verticalLineToRelative(dy = 4.58f)
                curveToRelative(dx1 = 0.0f, dy1 = 0.65f, dx2 = -0.28f, dy2 = 0.89f, dx3 = -0.94f, dy3 = 0.89f)
                horizontalLineTo(x = 8.44f)
                curveToRelative(dx1 = -0.66f, dy1 = 0.0f, dx2 = -0.94f, dy2 = -0.23f, dx3 = -0.94f, dy3 = -0.89f)
            }
