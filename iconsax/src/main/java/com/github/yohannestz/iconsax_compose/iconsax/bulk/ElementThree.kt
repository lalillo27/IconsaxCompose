...
val ElementThree: ImageVector
    get() {
        val current = _elementThree
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.ElementThree",
        ...
        }.build().also { _elementThree = it }
    }

@Suppress("ObjectPropertyName")
private var _elementThree: ImageVector? = null
