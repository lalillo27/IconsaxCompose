    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 4.75f, y = 13.97f)
                arcTo(horizontalEllipseRadius = 2.8f, verticalEllipseRadius = 2.8f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 7.54f, y1 = 17.0f)
                ...
                lineToRelative(dx = -0.5f, dy = 6.05f)
