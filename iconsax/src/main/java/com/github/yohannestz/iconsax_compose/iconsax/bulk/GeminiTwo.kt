    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                verticalLineTo(y = 3.81f)
                lineToRelative(dx = 2.02f, dy = 2.02f)
                quadTo(x1 = 15.0f, y1 = 6.05f, x2 = 15.3f, y2 = 6.05f)
                ...
                verticalLineTo(y = 6.81f)
                lineToRelative(dx = 0.72f, dy = 0.72f)
                quadTo(x1 = 22.7f, y1 = 7.75f, x2 = 23.0f, y2 = 7.75f)
                curveToRelative(dx1 = 0.3f, dy1 = 0.0f, dx2 = 0.38f, dy2 = -0.07f, dx3 = 0.53f, dy3 = -0.22f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.0f, dy1 = -1.06f)
            }
            path(
                ...
                moveTo(x = 15.0f, y = 20.75f)
                horizontalLineTo(x = 9.0f)
                curveToRelative(dx1 = -0.41f, dy1 = 0.0f, dx2 = -0.75f, dy2 = -0.34f, dx3 = -0.75f, dy3 = -0.75f)
                reflectiveCurveTo(x1 = 8.59f, y1 = 19.25f, x2 = 9.0f, y2 = 19.25f)
