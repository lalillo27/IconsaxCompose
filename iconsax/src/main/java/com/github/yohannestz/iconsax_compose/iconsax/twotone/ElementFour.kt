    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 10.5f, y = 13.1f)
                verticalLineToRelative(dy = 6.8f)
                curveToRelative(dx1 = 0.0f, dy1 = 1.5f, dx2 = -0.64f, dy2 = 2.1f, dx3 = -2.23f, dy3 = 2.1f)
                horizontalLineTo(x = 4.23f)
                curveTo(x1 = 2.64f, y1 = 22.0f, x2 = 2.0f, y2 = 21.4f, x3 = 2.0f, y3 = 19.9f)
                verticalLineToRelative(dy = -6.8f)
                curveTo(x1 = 2.0f, y1 = 11.6f, x2 = 2.64f, y2 = 11.0f, x3 = 4.23f, y3 = 11.0f)
                horizontalLineToRelative(dx = 4.04f)
                curveToRelative(dx1 = 1.59f, dy1 = 0.0f, dx2 = 2.23f, dy2 = 0.6f, dx3 = 2.23f, dy3 = 2.1f)
            }
            path(
                ...
                moveTo(x = 10.5f, y = 4.1f)
                verticalLineToRelative(dy = 1.8f)
                curveTo(x1 = 10.5f, y1 = 7.4f, x2 = 9.86f, y2 = 8.0f, x3 = 8.27f, y3 = 8.0f)
                horizontalLineTo(x = 4.23f)
                curveTo(x1 = 2.64f, y1 = 8.0f, x2 = 2.0f, y2 = 7.4f, x3 = 2.0f, y3 = 5.9f)
                verticalLineTo(y = 4.1f)
                curveTo(x1 = 2.0f, y1 = 2.6f, x2 = 2.64f, y2 = 2.0f, x3 = 4.23f, y3 = 2.0f)
                horizontalLineToRelative(dx = 4.04f)
                curveToRelative(dx1 = 1.59f, dy1 = 0.0f, dx2 = 2.23f, dy2 = 0.6f, dx3 = 2.23f, dy3 = 2.1f)
            }
