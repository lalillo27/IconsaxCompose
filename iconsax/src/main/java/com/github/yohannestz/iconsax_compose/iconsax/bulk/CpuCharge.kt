    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(dx1 = 0.0f, dy1 = 0.75f, dx2 = 0.21f, dy2 = 1.45f)
                moveToRelative(dx = 10.05f, dy = -9.71f)
                horizontalLineTo(x = 9.74f)
                ...
                arcToRelative(a = 3.0f, b = 3.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 3.0f, dy1 = -3.0f)
                verticalLineToRelative(dy = -4.5f)
                arcToRelative(a = 3.0f, b = 3.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -2.99f, dy1 = -3.0f)
                moveToRelative(dx = -0.67f, dy = 6.3f)
                lineToRelative(dx = -0.94f, dy = 1.64f)
                arcTo(horizontalEllipseRadius = 0.8f, verticalEllipseRadius = 0.8f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 12.0f, y1 = 15.06f)
                ...
                horizontalLineToRelative(dx = 0.59f)
                arcToRelative(a = 1.2f, b = 1.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.08f, dy1 = 0.57f)
                curveToRelative(dx1 = 0.22f, dy1 = 0.36f, dx2 = 0.2f, dy2 = 0.8f, dx3 = -0.04f, dy3 = 1.22f)
            }
