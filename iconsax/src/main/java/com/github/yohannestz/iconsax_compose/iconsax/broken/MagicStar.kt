    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 1.67f, dy1 = -1.2f, dx2 = 3.0f, dy2 = -0.5f, dx3 = 2.96f, dy3 = 1.55f)
                ...
                lineTo(x = 4.45f, y = 16.8f)
                curveToRelative(dx1 = -2.39f, dy1 = 0.12f, dx2 = -3.07f, dy2 = -1.26f, dx3 = -1.51f, dy3 = -3.08f)
                lineToRelative(dx = 1.98f, dy = -2.3f)
                arcToRelative(a = 2.0f, b = 2.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.39f, dy1 = -0.84f)
