    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 4.71f, verticalEllipseRadius = 4.71f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 18.0f, y1 = 13.25f)
                ...
                arcTo(horizontalEllipseRadius = 3.24f, verticalEllipseRadius = 3.24f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, x1 = 18.0f, y1 = 14.75f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
                moveTo(x = 17.43f, y = 19.74f)
