    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 4.27f, y = 5.5f)
                lineTo(x = 3.3f, y = 6.04f)
                arcTo(horizontalEllipseRadius = 2.2f, verticalEllipseRadius = 2.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 2.29f, y1 = 7.8f)
                ...
                arcTo(horizontalEllipseRadius = 2.2f, verticalEllipseRadius = 2.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 22.0f, y1 = 16.23f)
                verticalLineTo(y = 6.5f)
                curveToRelative(dx1 = 0.0f, dy1 = -1.9f, dx2 = -1.35f, dy2 = -2.68f, dx3 = -2.99f, dy3 = -1.74f)
                lineTo(x = 16.66f, y = 6.1f)
                arcToRelative(a = 2.2f, b = 2.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -1.89f, dy1 = 0.05f)
