    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = -0.2f, dy1 = 0.0f, dx2 = -0.4f, dy2 = -0.03f, dx3 = -0.6f, dy3 = 0.0f)
                arcToRelative(a = 3.0f, b = 3.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.49f, dy1 = -0.85f)
                lineToRelative(dx = 1.56f, dy = -1.97f)
                curveToRelative(dx1 = 2.58f, dy1 = -3.23f, dx2 = 7.82f, dy2 = -7.1f, dx3 = 11.65f, dy3 = -8.64f)
