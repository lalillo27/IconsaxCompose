    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 1.21f, dy1 = -0.76f, dx2 = 1.28f, dy2 = -2.53f, dx3 = 0.14f, dy3 = -3.66f)
                moveToRelative(dx = -9.91f, dy = 13.43f)
                lineToRelative(dx = -4.27f, dy = 0.5f)
                curveToRelative(dx1 = -1.84f, dy1 = 0.21f, dx2 = -3.16f, dy2 = -1.1f, dx3 = -2.94f, dy3 = -2.94f)
            ...
            path(
                ...
                moveTo(x = 7.7f, y = 7.68f)
                lineTo(x = 5.32f, y = 5.3f)
                moveToRelative(dx = 2.36f, dy = 0.02f)
                lineTo(x = 5.3f, y = 7.7f)
            }
