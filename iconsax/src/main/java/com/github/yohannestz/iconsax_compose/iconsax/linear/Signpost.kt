    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 1.74f, verticalEllipseRadius = 1.74f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 17.22f, y1 = 2.0f)
