    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 3.27f, y = 7.5f)
                arcToRelative(a = 10.0f, b = 10.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.0f, dy1 = 8.99f)
                ...
                arcToRelative(a = 9.0f, b = 9.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.21f, dy1 = -2.04f)
                ...
                arcTo(horizontalEllipseRadius = 9.98f, verticalEllipseRadius = 9.98f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 6.43f, y1 = 3.82f)
            }
