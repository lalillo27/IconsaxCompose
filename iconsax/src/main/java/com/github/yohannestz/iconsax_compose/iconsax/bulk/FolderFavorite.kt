    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(dx = -7.45f, dy = 5.13f)
                ...
                lineToRelative(dx = -2.15f, dy = -1.88f)
                arcToRelative(a = 1.69f, b = 1.69f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 2.13f, dy1 = -2.63f)
                ...
                arcToRelative(a = 1.7f, b = 1.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.19f, dy1 = 2.33f)
            }
