    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 0.75f, verticalEllipseRadius = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 7.7f, y1 = 16.7f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.38f, dy1 = -0.99f)
                lineToRelative(dx = 4.0f, dy = -9.0f)
                curveToRelative(dx1 = 0.24f, dy1 = -0.54f, dx2 = 1.13f, dy2 = -0.54f, dx3 = 1.37f, dy3 = 0.0f)
                lineToRelative(dx = 4.0f, dy = 9.0f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.38f, dy1 = 1.0f)
                arcTo(horizontalEllipseRadius = 1.0f, verticalEllipseRadius = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 16.0f, y1 = 16.74f)
            }
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
