    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(dx = -0.47f, dy = -0.49f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.12f, dy1 = -1.22f)
                lineToRelative(dx = 5.12f, dy = -8.22f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.85f, dy1 = -0.47f)
                ...
                moveTo(x = 10.35f, y = 3.63f)
                lineTo(x = 6.8f, y = 9.33f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -1.57f, dy1 = 0.15f)
                lineTo(x = 4.3f, y = 8.5f)
