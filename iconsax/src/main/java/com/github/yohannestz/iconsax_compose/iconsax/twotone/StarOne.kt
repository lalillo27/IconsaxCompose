    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 13.73f, y = 3.51f)
                lineToRelative(dx = 1.76f, dy = 3.52f)
                arcToRelative(a = 2.2f, b = 2.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 1.42f, dy1 = 1.05f)
                ...
                lineToRelative(dx = 1.76f, dy = -3.52f)
                curveToRelative(dx1 = 0.96f, dy1 = -1.91f, dx2 = 2.52f, dy2 = -1.91f, dx3 = 3.47f, dy3 = 0.0f)
            }
