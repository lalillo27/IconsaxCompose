    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = -3.35f, dy = -8.13f)
                ...
                arcTo(horizontalEllipseRadius = 4.44f, verticalEllipseRadius = 4.44f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 11.99f, y1 = 2.0f)
                arcToRelative(a = 4.43f, b = 4.43f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.16f, dy1 = 8.87f)
                moveToRelative(dx = -0.16f, dy = 10.94f)
