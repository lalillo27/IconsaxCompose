    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 0.11f, dy1 = -0.98f, dx2 = 0.13f, dy2 = -2.42f, dx3 = -0.83f, dy3 = -3.5f)
                moveTo(x = 8.42f, y = 13.15f)
                close()
                curveToRelative(dx1 = -0.55f, dy1 = 0.0f, dx2 = -1.0f, dy2 = -0.45f, dx3 = -1.0f, dy3 = -1.0f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 2.01f, dy1 = 0.0f)
