    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.87f, dy1 = -0.5f)
                horizontalLineTo(x = 7.92f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.87f, dy1 = 0.5f)
                lineToRelative(dx = -0.74f, dy = 1.28f)
                curveTo(x1 = 4.66f, y1 = 15.65f, x2 = 6.01f, y2 = 18.0f, x3 = 9.33f, y3 = 18.0f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
                fillAlpha = 0.4f,
                ...
                lineToRelative(dx = -0.64f, dy = 1.1f)
                arcTo(horizontalEllipseRadius = 0.5f, verticalEllipseRadius = 0.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 8.79f, y1 = 10.0f)
            }
