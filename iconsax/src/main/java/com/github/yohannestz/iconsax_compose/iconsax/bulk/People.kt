    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 2.87f, b = 2.87f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 2.79f, dy1 = -2.88f)
                arcToRelative(a = 2.9f, b = 2.9f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -5.78f, dy1 = 0.0f)
                arcToRelative(a = 2.9f, b = 2.9f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 2.79f, dy1 = 2.88f)
            ...
            path(
                ...
                arcToRelative(a = 3.43f, b = 3.43f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = true, dx1 = 6.88f, dy1 = 0.0f)
                arcToRelative(a = 3.4f, b = 3.4f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -3.31f, dy1 = 3.43f)
