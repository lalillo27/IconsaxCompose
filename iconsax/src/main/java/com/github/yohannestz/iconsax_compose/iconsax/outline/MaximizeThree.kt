...
val MaximizeThree: ImageVector
    get() {
        val current = _maximizeThree
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.MaximizeThree",
            ...
            path(
                ...
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = 1.06f)
                lineToRelative(dx = -12.0f, dy = 12.0f)
                arcTo(horizontalEllipseRadius = 0.7f, verticalEllipseRadius = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 6.0f, y1 = 18.75f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
                ...
                arcTo(horizontalEllipseRadius = 0.76f, verticalEllipseRadius = 0.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 18.75f, y1 = 6.0f)
                ...
                reflectiveCurveTo(x1 = 6.75f, y1 = 13.59f, x2 = 6.75f, y2 = 14.0f)
                verticalLineToRelative(dy = 3.25f)
                horizontalLineTo(x = 10.0f)
                curveToRelative(dx1 = 0.41f, dy1 = 0.0f, dx2 = 0.75f, dy2 = 0.34f, dx3 = 0.75f, dy3 = 0.75f)
                reflectiveCurveToRelative(dx1 = -0.34f, dy1 = 0.75f, dx2 = -0.75f, dy2 = 0.75f)
            }
        }.build().also { _maximizeThree = it }
    }

@Suppress("ObjectPropertyName")
private var _maximizeThree: ImageVector? = null
