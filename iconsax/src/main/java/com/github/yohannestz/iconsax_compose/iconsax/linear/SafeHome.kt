    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 5.8f, b = 5.8f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -4.2f, dy1 = 5.41f)
            ...
            path(
                ...
                lineToRelative(dx = -0.43f, dy = 2.59f)
                lineToRelative(dx = -1.0f, dy = -0.41f)
                ...
                arcToRelative(a = 3.05f, b = 3.05f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 3.66f, dy1 = 0.01f)
