    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 0.0f, dy1 = -0.68f, dx2 = -0.5f, dy2 = -1.48f, dx3 = -1.1f, dy3 = -1.79f)
                arcToRelative(a = 0.8f, b = 0.8f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.69f, dy1 = 0.0f)
                arcToRelative(a = 2.2f, b = 2.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.1f, dy1 = 1.79f)
                ...
                verticalLineToRelative(dy = 1.85f)
                curveToRelative(dx1 = 0.0f, dy1 = 0.17f, dx2 = -0.1f, dy2 = 0.4f, dx3 = -0.21f, dy3 = 0.51f)
                lineTo(x = 8.7f, y = 16.87f)
                curveToRelative(dx1 = -0.17f, dy1 = 0.17f, dx2 = -0.25f, dy2 = 0.51f, dx3 = -0.17f, dy3 = 0.74f)
                lineToRelative(dx = 0.32f, dy = 0.96f)
