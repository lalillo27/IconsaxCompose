    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 11.73f, y = 7.4f)
                lineTo(x = 7.58f, y = 5.0f)
                ...
                arcTo(horizontalEllipseRadius = 2.56f, verticalEllipseRadius = 2.56f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 7.58f, y1 = 19.0f)
                lineToRelative(dx = 4.15f, dy = -2.39f)
                lineToRelative(dx = 4.15f, dy = -2.4f)
                arcToRelative(a = 2.54f, b = 2.54f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.0f, dy1 = -4.4f)
