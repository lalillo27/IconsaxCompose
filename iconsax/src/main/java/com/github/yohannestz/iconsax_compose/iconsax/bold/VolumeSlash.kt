    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = -5.79f, dy = -6.3f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.71f, dy1 = 0.72f)
                ...
                close()
                moveToRelative(dx = 7.73f, dy = -10.72f)
                ...
                curveToRelative(dx1 = -0.06f, dy1 = -1.6f, dx2 = -0.66f, dy2 = -2.8f, dx3 = -1.72f, dy3 = -3.4f)
                curveToRelative(dx1 = -1.12f, dy1 = -0.61f, dx2 = -2.55f, dy2 = -0.45f, dx3 = -4.01f, dy3 = 0.46f)
                lineTo(x = 7.09f, y = 6.06f)
                arcToRelative(a = 1.3f, b = 1.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.66f, dy1 = 0.19f)
                ...
                arcTo(horizontalEllipseRadius = 1.0f, verticalEllipseRadius = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 2.77f, y1 = 22.0f)
                quadToRelative(dx1 = 0.3f, dy1 = 0.0f, dx2 = 0.54f, dy2 = -0.23f)
