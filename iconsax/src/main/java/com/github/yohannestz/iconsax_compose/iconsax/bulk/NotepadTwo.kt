    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(dx = -0.98f, dy = 4.18f)
                curveToRelative(dx1 = -0.98f, dy1 = 4.18f, dx2 = 0.3f, dy2 = 6.24f, dx3 = 4.48f, dy3 = 7.23f)
                lineToRelative(dx = 1.68f, dy = 0.4f)
                arcToRelative(a = 11.0f, b = 11.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 1.62f, dy1 = 0.27f)
                moveToRelative(dx = 2.43f, dy = -8.89f)
                quadToRelative(dx1 = -0.09f, dy1 = 0.0f, dx2 = -0.19f, dy2 = -0.02f)
