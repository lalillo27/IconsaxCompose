    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 4.7f, b = 4.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.69f, dy1 = 2.45f)
                arcToRelative(a = 4.7f, b = 4.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -4.06f, dy1 = 2.3f)
                arcToRelative(a = 4.7f, b = 4.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -4.06f, dy1 = -2.3f)
                arcToRelative(a = 4.7f, b = 4.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.69f, dy1 = -2.45f)
                arcToRelative(a = 4.75f, b = 4.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 9.5f, dy1 = 0.0f)
                moveToRelative(dx = -3.48f, dy = 1.24f)
                lineToRelative(dx = -2.51f, dy = -2.51f)
                moveToRelative(dx = 2.49f, dy = 0.03f)
                lineToRelative(dx = -2.51f, dy = 2.51f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
