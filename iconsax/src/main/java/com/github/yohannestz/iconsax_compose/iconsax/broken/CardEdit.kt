    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 7.5f, dy = 8.53f)
            ...
            path(
                ...
                curveToRelative(dx1 = 0.64f, dy1 = -0.64f, dx2 = 0.94f, dy2 = -1.38f, dx3 = 0.0f, dy3 = -2.32f)
                curveToRelative(dx1 = -0.95f, dy1 = -0.95f, dx2 = -1.69f, dy2 = -0.65f, dx3 = -2.33f, dy3 = 0.0f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
