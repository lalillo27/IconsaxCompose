    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 10.35f, dy = 0.0f)
                verticalLineTo(y = 4.89f)
                curveTo(x1 = 21.0f, y1 = 3.54f, x2 = 20.43f, y2 = 3.0f, x3 = 18.99f, y3 = 3.0f)
                horizontalLineToRelative(dx = -3.63f)
                curveToRelative(dx1 = -1.43f, dy1 = 0.0f, dx2 = -2.01f, dy2 = 0.54f, dx3 = -2.01f, dy3 = 1.89f)
                verticalLineToRelative(dy = 14.22f)
                curveToRelative(dx1 = 0.0f, dy1 = 1.35f, dx2 = 0.57f, dy2 = 1.89f, dx3 = 2.01f, dy3 = 1.89f)
                horizontalLineToRelative(dx = 3.63f)
                curveToRelative(dx1 = 1.44f, dy1 = 0.0f, dx2 = 2.01f, dy2 = -0.54f, dx3 = 2.01f, dy3 = -1.89f)
            }
