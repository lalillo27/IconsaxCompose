    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(dx = -0.18f, dy = 1.07f)
                lineToRelative(dx = -0.7f, dy = -0.28f)
                arcToRelative(a = 4.0f, b = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -3.08f, dy1 = 0.0f)
                lineToRelative(dx = -2.79f, dy = 1.15f)
                arcToRelative(a = 2.7f, b = 2.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.61f, dy1 = 2.42f)
                verticalLineToRelative(dy = 2.2f)
                arcTo(horizontalEllipseRadius = 7.0f, verticalEllipseRadius = 7.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 13.53f, y1 = 21.0f)
