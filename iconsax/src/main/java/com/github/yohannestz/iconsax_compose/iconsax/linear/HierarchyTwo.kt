    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 0.25f, dy = 14.0f)
                ...
                arcToRelative(a = 3.0f, b = 3.0f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, dx1 = 0.0f, dy1 = -6.0f)
                arcToRelative(a = 3.0f, b = 3.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.0f, dy1 = 6.0f)
                moveTo(x = 5.13f, y = 15.0f)
                arcToRelative(a = 4.06f, b = 4.06f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 3.94f, dy1 = -3.04f)
                lineToRelative(dx = 3.43f, dy = 0.01f)
                arcToRelative(a = 6.0f, b = 6.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 5.67f, dy1 = -4.01f)
            }
