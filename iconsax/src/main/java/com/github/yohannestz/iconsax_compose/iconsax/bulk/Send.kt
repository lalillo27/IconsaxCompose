    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 1.8f, b = 1.8f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.0f, dy1 = -1.61f)
                lineTo(x = 4.28f, y = 9.46f)
                curveTo(x1 = 1.4f, y1 = 3.7f, x2 = 3.76f, y2 = 1.35f, x3 = 9.51f, y3 = 4.23f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
                moveTo(x = 14.84f, y = 12.75f)
