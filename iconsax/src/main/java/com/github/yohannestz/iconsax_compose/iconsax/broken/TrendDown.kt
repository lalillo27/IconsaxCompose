...
val TrendDown: ImageVector
    get() {
        val current = _trendDown
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.TrendDown",
            ...
            path(
                ...
                moveTo(x = 11.17f, y = 12.0f)
                lineToRelative(dx = -0.47f, dy = 0.7f)
