    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(dx = 1.53f, dy = 1.53f)
                lineTo(x = 18.55f, y = 4.41f)
                close()
                moveToRelative(dx = 4.1f, dy = 4.1f)
                lineToRelative(dx = -1.51f, dy = -1.51f)
                lineTo(x = 5.47f, y = 19.6f)
                lineToRelative(dx = 1.51f, dy = 1.5f)
                ...
                lineToRelative(dx = 1.92f, dy = -1.92f)
