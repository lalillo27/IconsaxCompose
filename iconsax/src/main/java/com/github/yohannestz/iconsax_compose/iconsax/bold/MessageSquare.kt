    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 2.09f, dy = 10.91f)
                quadToRelative(dx1 = 0.0f, dy1 = 0.3f, dx2 = -0.03f, dy2 = 0.59f)
                quadToRelative(dx1 = -0.27f, dy1 = 3.18f, dx2 = -3.73f, dy2 = 3.18f)
                ...
                lineTo(x = 9.49f, y = 6.0f)
                horizontalLineToRelative(dx = 5.03f)
                quadToRelative(dx1 = 3.76f, dy1 = 0.0f, dx2 = 3.76f, dy2 = 3.76f)
                close()
            }
