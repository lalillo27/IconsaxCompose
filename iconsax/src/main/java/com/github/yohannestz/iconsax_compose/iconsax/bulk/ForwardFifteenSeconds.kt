    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 8.15f, verticalEllipseRadius = 8.15f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = true, x1 = 12.0f, y1 = 4.97f)
                ...
                quadToRelative(dx1 = 0.09f, dy1 = -0.02f, dx2 = 0.16f, dy2 = -0.06f)
                ...
                quadToRelative(dx1 = 0.04f, dy1 = -0.06f, dx2 = 0.06f, dy2 = -0.14f)
                ...
                arcToRelative(a = 9.4f, b = 9.4f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.93f, dy1 = -5.74f)
            }
