    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 8.0f, b = 8.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.67f, dy1 = -3.1f)
                curveToRelative(dx1 = 0.0f, dy1 = -4.91f, dx2 = 4.22f, dy2 = -8.78f, dx3 = 9.02f, dy3 = -7.73f)
                arcToRelative(a = 7.3f, b = 7.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 3.76f, dy1 = 2.18f)
                moveToRelative(dx = 1.7f, dy = 2.95f)
