    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                horizontalLineToRelative(dx = -3.07f)
                moveTo(x = 4.0f, y = 11.88f)
                arcToRelative(a = 3.0f, b = 3.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 1.53f, dy1 = 2.61f)
                lineToRelative(dx = 2.96f, dy = 1.67f)
                arcToRelative(a = 2.0f, b = 2.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.02f, dy1 = 1.74f)
