    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 20.0f, y = 15.77f)
                arcToRelative(a = 4.5f, b = 4.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -6.18f, dy1 = -1.09f)
                moveToRelative(dx = -3.64f, dy = -5.36f)
                ...
                arcTo(horizontalEllipseRadius = 4.55f, verticalEllipseRadius = 4.55f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 22.0f, y1 = 12.0f)
            }
