    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 2.57f, b = 2.57f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -2.48f, dy1 = -2.58f)
                arcTo(horizontalEllipseRadius = 2.57f, verticalEllipseRadius = 2.57f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 17.91f, y1 = 2.0f)
                arcToRelative(a = 2.6f, b = 2.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 2.58f, dy1 = 2.58f)
                arcTo(horizontalEllipseRadius = 2.6f, verticalEllipseRadius = 2.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 18.0f, y1 = 7.16f)
                ...
                arcToRelative(a = 2.6f, b = 2.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 2.58f, dy1 = 2.58f)
                arcTo(horizontalEllipseRadius = 2.6f, verticalEllipseRadius = 2.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 12.0f, y1 = 14.63f)
                moveToRelative(dx = -2.91f, dy = 3.15f)
                curveToRelative(dx1 = -1.41f, dy1 = 0.94f, dx2 = -1.41f, dy2 = 2.48f, dx3 = 0.0f, dy3 = 3.42f)
