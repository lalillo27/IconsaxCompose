    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(dx = 0.75f, dy = -2.29f)
                ...
                moveToRelative(dx = -4.89f, dy = 0.0f)
                arcToRelative(a = 0.76f, b = 0.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.75f, dy1 = -0.75f)
                verticalLineToRelative(dy = -3.39f)
                lineTo(x = 8.6f, y = 13.0f)
                arcToRelative(a = 0.76f, b = 0.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -1.06f, dy1 = 0.06f)
                arcTo(horizontalEllipseRadius = 0.76f, verticalEllipseRadius = 0.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 7.48f, y1 = 12.0f)
                ...
                moveToRelative(dx = 4.44f, dy = -11.7f)
            ...
            path(
                ...
                arcToRelative(a = 9.0f, b = 9.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 2.15f, dy1 = 0.26f)
                ...
                arcToRelative(a = 8.15f, b = 8.15f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, dx1 = 6.33f, dy1 = 7.92f)
                ...
                arcTo(horizontalEllipseRadius = 9.65f, verticalEllipseRadius = 9.65f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 12.0f, y1 = 22.75f)
            }
