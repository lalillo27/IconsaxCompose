    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 18.02f, y = 3.01f)
                arcToRelative(a = 18.0f, b = 18.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.94f, dy1 = -0.91f)
                ...
                arcToRelative(a = 31.0f, b = 31.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 5.66f, dy1 = -5.18f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
