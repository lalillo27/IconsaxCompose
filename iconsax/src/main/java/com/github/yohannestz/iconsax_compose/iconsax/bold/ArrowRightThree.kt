    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.5f, dy1 = -0.87f)
                lineToRelative(dx = -1.28f, dy = -0.74f)
                curveTo(x1 = 8.35f, y1 = 4.66f, x2 = 6.0f, y2 = 6.01f, x3 = 6.0f, y3 = 9.33f)
                moveToRelative(dx = 8.0f, dy = -0.54f)
                verticalLineToRelative(dy = 6.43f)
                arcToRelative(a = 0.5f, b = 0.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.75f, dy1 = 0.43f)
                lineToRelative(dx = 1.1f, dy = -0.64f)
                curveToRelative(dx1 = 2.87f, dy1 = -1.65f, dx2 = 2.87f, dy2 = -4.37f, dx3 = 0.0f, dy3 = -6.02f)
                lineToRelative(dx = -1.1f, dy = -0.64f)
                arcTo(horizontalEllipseRadius = 0.5f, verticalEllipseRadius = 0.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 14.0f, y1 = 8.8f)
            }
