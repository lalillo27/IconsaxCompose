    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 8.13f, b = 8.13f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = true, dx1 = -8.42f, dy1 = -7.84f)
                arcToRelative(a = 8.0f, b = 8.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.82f, dy1 = 0.16f)
                ...
                arcToRelative(a = 9.6f, b = 9.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -2.17f, dy1 = -5.69f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
