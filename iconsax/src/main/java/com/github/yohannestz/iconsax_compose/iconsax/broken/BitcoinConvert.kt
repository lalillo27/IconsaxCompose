    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(dx = 0.02f, dy = 0.48f)
                arcToRelative(a = 6.17f, b = 6.17f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -11.29f, dy1 = 3.45f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
                ...
                arcTo(horizontalEllipseRadius = 6.17f, verticalEllipseRadius = 6.17f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 19.88f, y1 = 4.5f)
            }
