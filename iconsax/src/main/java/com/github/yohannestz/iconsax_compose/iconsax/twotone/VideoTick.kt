    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                quadTo(x1 = 15.34f, y1 = 22.0f, x2 = 15.0f, y2 = 22.0f)
            ...
            path(
                ...
                arcToRelative(a = 4.5f, b = 4.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -1.54f, dy1 = 3.38f)
                arcToRelative(a = 4.4f, b = 4.4f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -5.79f, dy1 = 0.1f)
