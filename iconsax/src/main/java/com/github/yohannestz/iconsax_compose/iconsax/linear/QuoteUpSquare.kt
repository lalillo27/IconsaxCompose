    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 1.2f, verticalEllipseRadius = 1.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 17.0f, y1 = 9.16f)
                close()
                moveToRelative(dx = 0.0f, dy = 0.0f)
                curveToRelative(dx1 = 0.0f, dy1 = 2.79f, dx2 = -0.52f, dy2 = 3.26f, dx3 = -2.09f, dy3 = 4.19f)
                moveToRelative(dx = -4.05f, dy = -4.19f)
