    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 0.0f, dy1 = -1.31f, dx2 = -0.82f, dy2 = -1.49f, dx3 = -1.65f, dy3 = -1.26f)
                lineToRelative(dx = -3.14f, dy = 0.86f)
                arcTo(horizontalEllipseRadius = 1.25f, verticalEllipseRadius = 1.25f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 10.0f, y1 = 9.21f)
            ...
            path(
                ...
                arcToRelative(a = 1.57f, b = 1.57f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, dx1 = 0.0f, dy1 = -3.14f)
                arcToRelative(a = 1.57f, b = 1.57f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.0f, dy1 = 3.14f)
                moveToRelative(dx = -4.19f, dy = -5.02f)
