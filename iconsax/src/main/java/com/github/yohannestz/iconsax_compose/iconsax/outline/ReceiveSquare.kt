...
val ReceiveSquare: ImageVector
    get() {
        val current = _receiveSquare
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.ReceiveSquare",
            ...
            path(
                ...
                lineTo(x = 12.0f, y = 13.45f)
                lineToRelative(dx = 2.47f, dy = -2.47f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.06f, dy1 = 0.0f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = 1.06f)
                lineToRelative(dx = -3.0f, dy = 3.0f)
                arcTo(horizontalEllipseRadius = 0.7f, verticalEllipseRadius = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 12.0f, y1 = 15.26f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
                ...
                verticalLineToRelative(dy = 8.0f)
                arcTo(horizontalEllipseRadius = 0.75f, verticalEllipseRadius = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 12.0f, y1 = 15.26f)
                moveToRelative(dx = 0.0f, dy = 2.97f)
                curveToRelative(dx1 = -2.11f, dy1 = 0.0f, dx2 = -4.23f, dy2 = -0.34f, dx3 = -6.24f, dy3 = -1.01f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.47f, dy1 = -0.95f)
                arcToRelative(a = 0.74f, b = 0.74f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.95f, dy1 = -0.47f)
                ...
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.47f, dy1 = 0.95f)
                arcTo(horizontalEllipseRadius = 20.0f, verticalEllipseRadius = 20.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 12.0f, y1 = 18.23f)
            }
        }.build().also { _receiveSquare = it }
    }
