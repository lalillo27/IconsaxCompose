    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 0.73f, dy1 = 0.0f, dx2 = 1.04f, dy2 = 0.26f, dx3 = 1.04f, dy3 = 0.99f)
                verticalLineToRelative(dy = 5.09f)
                curveToRelative(dx1 = 0.0f, dy1 = 0.73f, dx2 = -0.31f, dy2 = 0.99f, dx3 = -1.04f, dy3 = 0.99f)
                horizontalLineTo(x = 8.04f)
                curveTo(x1 = 7.31f, y1 = 14.79f, x2 = 7.0f, y2 = 14.53f, x3 = 7.0f, y3 = 13.8f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
