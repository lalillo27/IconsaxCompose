...
val ArrowCircleUpTwo: ImageVector
    get() {
        val current = _arrowCircleUpTwo
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.ArrowCircleUpTwo",
            ...
            path(
                ...
                verticalLineToRelative(dy = 6.0f)
                arcTo(horizontalEllipseRadius = 0.76f, verticalEllipseRadius = 0.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 12.0f, y1 = 16.25f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
        ...
        }.build().also { _arrowCircleUpTwo = it }
    }

@Suppress("ObjectPropertyName")
private var _arrowCircleUpTwo: ImageVector? = null
