    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                quadToRelative(dx1 = 0.15f, dy1 = 0.0f, dx2 = 0.3f, dy2 = -0.06f)
                ...
                reflectiveCurveTo(x1 = 14.1f, y1 = 8.69f, x2 = 14.1f, y2 = 9.1f)
                verticalLineToRelative(dy = 2.43f)
                lineTo(x = 9.71f, y = 7.15f)
                ...
                close()
                moveToRelative(dx = 5.69f, dy = 3.69f)
