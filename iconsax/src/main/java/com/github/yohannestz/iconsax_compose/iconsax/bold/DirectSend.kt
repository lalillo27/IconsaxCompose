    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 0.7f, b = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.7f, dy1 = -0.7f)
                moveToRelative(dx = -8.55f, dy = -8.42f)
            ...
            path(
                ...
                verticalLineToRelative(dy = -0.04f)
                curveTo(x1 = 2.0f, y1 = 7.17f, x2 = 4.17f, y2 = 5.0f, x3 = 7.81f, y3 = 5.0f)
                horizontalLineToRelative(dx = 3.44f)
                verticalLineToRelative(dy = 4.0f)
                curveToRelative(dx1 = 0.0f, dy1 = 0.41f, dx2 = 0.34f, dy2 = 0.75f, dx3 = 0.75f, dy3 = 0.75f)
                reflectiveCurveTo(x1 = 12.75f, y1 = 9.41f, x2 = 12.75f, y2 = 9.0f)
                verticalLineTo(y = 5.0f)
                horizontalLineToRelative(dx = 3.44f)
                curveTo(x1 = 19.83f, y1 = 5.0f, x2 = 22.0f, y2 = 7.17f, x3 = 22.0f, y3 = 10.81f)
            }
