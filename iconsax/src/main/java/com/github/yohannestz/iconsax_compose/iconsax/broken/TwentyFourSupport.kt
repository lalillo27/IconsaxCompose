    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 1.7f, b = 1.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.69f, dy1 = -1.69f)
                arcToRelative(a = 1.7f, b = 1.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.69f, dy1 = 1.7f)
                curveToRelative(dx1 = 0.0f, dy1 = 1.87f, dx2 = -2.67f, dy2 = 2.07f, dx3 = -3.26f, dy3 = 3.86f)
