    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 3.88f, dy = 7.47f)
                arcToRelative(a = 1.2f, b = 1.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.8f, dy1 = -0.6f)
                lineToRelative(dx = -0.28f, dy = -0.57f)
                curveToRelative(dx1 = -0.54f, dy1 = -1.09f, dx2 = -1.42f, dy2 = -1.09f, dx3 = -1.95f, dy3 = 0.0f)
                lineToRelative(dx = -0.28f, dy = 0.57f)
                arcToRelative(a = 1.3f, b = 1.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.8f, dy1 = 0.6f)
                lineToRelative(dx = -0.38f, dy = 0.06f)
                curveToRelative(dx1 = -1.14f, dy1 = 0.19f, dx2 = -1.41f, dy2 = 1.03f, dx3 = -0.59f, dy3 = 1.86f)
                lineToRelative(dx = 0.35f, dy = 0.35f)
                arcToRelative(a = 1.3f, b = 1.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.29f, dy1 = 1.02f)
                lineToRelative(dx = -0.05f, dy = 0.21f)
                curveToRelative(dx1 = -0.31f, dy1 = 1.38f, dx2 = 0.42f, dy2 = 1.91f, dx3 = 1.62f, dy3 = 1.19f)
                lineToRelative(dx = 0.26f, dy = -0.15f)
                arcToRelative(a = 1.2f, b = 1.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.12f, dy1 = 0.0f)
                lineToRelative(dx = 0.26f, dy = 0.15f)
                curveToRelative(dx1 = 1.21f, dy1 = 0.73f, dx2 = 1.94f, dy2 = 0.19f, dx3 = 1.62f, dy3 = -1.19f)
                lineToRelative(dx = -0.05f, dy = -0.21f)
            }
