    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineTo(x = 18.6f, y = 7.3f)
                arcToRelative(a = 2.06f, b = 2.06f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.01f, dy1 = 2.88f)
                moveTo(x = 8.0f, y = 21.74f)
