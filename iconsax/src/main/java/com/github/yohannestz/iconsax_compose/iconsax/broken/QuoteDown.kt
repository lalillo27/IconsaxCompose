    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 2.6f, verticalEllipseRadius = 2.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 22.0f, y1 = 5.86f)
            ...
            path(
                ...
                close()
                moveToRelative(dx = -0.01f, dy = 0.0f)
                curveToRelative(dx1 = 0.0f, dy1 = 6.05f, dx2 = -1.13f, dy2 = 7.05f, dx3 = -4.53f, dy3 = 9.07f)
            }
