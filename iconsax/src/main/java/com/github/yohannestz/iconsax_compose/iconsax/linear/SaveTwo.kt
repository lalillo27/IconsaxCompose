    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 3.1f, verticalEllipseRadius = 3.1f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 2.0f, y1 = 8.99f)
                ...
                lineToRelative(dx = 3.93f, dy = 2.19f)
                curveToRelative(dx1 = 1.27f, dy1 = 0.71f, dx2 = 2.31f, dy2 = 0.09f, dx3 = 2.31f, dy3 = -1.36f)
                verticalLineTo(y = 8.99f)
                arcToRelative(a = 3.1f, b = 3.1f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -3.1f, dy1 = -3.11f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
                ...
                lineToRelative(dx = -3.93f, dy = 2.19f)
                curveTo(x1 = 3.04f, y1 = 22.41f, x2 = 2.0f, y2 = 21.8f, x3 = 2.0f, y3 = 20.35f)
                verticalLineTo(y = 8.99f)
                curveToRelative(dx1 = 0.0f, dy1 = -1.71f, dx2 = 1.4f, dy2 = -3.11f, dx3 = 3.11f, dy3 = -3.11f)
                horizontalLineToRelative(dx = 7.78f)
                curveToRelative(dx1 = 1.71f, dy1 = 0.0f, dx2 = 3.11f, dy2 = 1.4f, dx3 = 3.11f, dy3 = 3.11f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
