    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.54f, dy1 = -0.84f)
                lineToRelative(dx = 2.06f, dy = 1.34f)
                curveToRelative(dx1 = 0.8f, dy1 = 0.53f, dx2 = 1.8f, dy2 = 0.79f, dx3 = 2.8f, dy3 = 0.79f)
                reflectiveCurveToRelative(dx1 = 2.0f, dy1 = -0.26f, dx2 = 2.78f, dy2 = -0.79f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
