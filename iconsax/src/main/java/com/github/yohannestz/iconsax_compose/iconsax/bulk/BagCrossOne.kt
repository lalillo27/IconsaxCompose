    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 16.19f, y = 8.86f)
                arcToRelative(a = 0.7f, b = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.7f, dy1 = -0.7f)
                verticalLineTo(y = 6.88f)
                arcToRelative(a = 3.5f, b = 3.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -3.83f, dy1 = -3.47f)
                curveTo(x1 = 9.98f, y1 = 3.57f, x2 = 8.51f, y2 = 5.28f, x3 = 8.51f, y3 = 7.06f)
                verticalLineToRelative(dy = 0.9f)
                arcToRelative(a = 0.7f, b = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.7f, dy1 = 0.7f)
                arcToRelative(a = 0.7f, b = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.7f, dy1 = -0.7f)
                verticalLineToRelative(dy = -0.9f)
                curveToRelative(dx1 = 0.0f, dy1 = -2.5f, dx2 = 2.02f, dy2 = -4.81f, dx3 = 4.41f, dy3 = -5.04f)
                arcToRelative(a = 4.87f, b = 4.87f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 5.36f, dy1 = 4.86f)
            ...
            path(
                ...
                curveToRelative(dx1 = -0.84f, dy1 = -0.93f, dx2 = -2.22f, dy2 = -1.38f, dx3 = -4.24f, dy3 = -1.38f)
                horizontalLineTo(x = 8.28f)
                curveToRelative(dx1 = -2.02f, dy1 = 0.0f, dx2 = -3.4f, dy2 = 0.45f, dx3 = -4.24f, dy3 = 1.38f)
            ...
            path(
                ...
                moveTo(x = 12.0f, y = 18.58f)
                arcTo(horizontalEllipseRadius = 3.79f, verticalEllipseRadius = 3.79f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, x1 = 12.0f, y1 = 11.0f)
                arcToRelative(a = 3.79f, b = 3.79f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.0f, dy1 = 7.58f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
                moveTo(x = 13.6f, y = 15.31f)
