    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 3.05f, y1 = 3.58f, x2 = 2.0f, y2 = 4.63f, x3 = 2.0f, y3 = 7.78f)
                moveToRelative(dx = 14.74f, dy = 3.17f)
                verticalLineToRelative(dy = 5.26f)
                curveToRelative(dx1 = 0.0f, dy1 = 3.16f, dx2 = -1.05f, dy2 = 4.21f, dx3 = -4.2f, dy3 = 4.21f)
