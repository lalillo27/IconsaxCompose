    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 17.31f, y = 11.25f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.27f, dy1 = 0.73f)
                lineTo(x = 11.02f, y = 18.0f)
                quadToRelative(dx1 = -2.0f, dy1 = 2.0f, dx2 = -4.01f, dy2 = 0.0f)
                lineTo(x = 3.0f, y = 13.99f)
                quadToRelative(dx1 = -1.03f, dy1 = -1.04f, dx2 = -1.0f, dy2 = -2.07f)
            ...
            path(
                ...
                horizontalLineToRelative(dx = 0.07f)
                lineToRelative(dx = 15.12f, dy = -0.66f)
                lineToRelative(dx = 0.12f, dy = -0.01f)
            ...
            path(
                ...
                curveToRelative(dx1 = -0.31f, dy1 = 0.34f, dx2 = -1.85f, dy2 = 2.08f, dx3 = -1.85f, dy3 = 3.39f)
