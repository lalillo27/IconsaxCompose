    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 6.0f, b = 6.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -1.99f, dy1 = -0.32f)
                arcToRelative(a = 3.5f, b = 3.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -2.29f, dy1 = -2.81f)
                arcToRelative(a = 6.0f, b = 6.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 1.28f, dy1 = 0.13f)
                horizontalLineToRelative(dx = 8.8f)
                curveToRelative(dx1 = 2.63f, dy1 = 0.0f, dx2 = 4.4f, dy2 = -1.32f, dx3 = 4.4f, dy3 = -4.4f)
                verticalLineTo(y = 7.92f)
