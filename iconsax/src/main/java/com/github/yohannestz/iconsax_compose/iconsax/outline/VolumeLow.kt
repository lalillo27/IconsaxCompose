...
val VolumeLow: ImageVector
    get() {
        val current = _volumeLow
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.VolumeLow",
