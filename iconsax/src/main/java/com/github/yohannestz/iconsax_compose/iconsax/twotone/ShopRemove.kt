    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 21.01f, y = 11.22f)
                verticalLineToRelative(dy = 4.49f)
                curveToRelative(dx1 = 0.0f, dy1 = 4.49f, dx2 = -1.79f, dy2 = 6.29f, dx3 = -6.29f, dy3 = 6.29f)
                horizontalLineTo(x = 9.33f)
                quadToRelative(dx1 = -0.87f, dy1 = 0.0f, dx2 = -1.6f, dy2 = -0.1f)
                moveToRelative(dx = -4.69f, dy = -6.38f)
            ...
            path(
                ...
                moveTo(x = 5.67f, y = 12.0f)
                arcToRelative(a = 3.4f, b = 3.4f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 3.3f, dy1 = -2.99f)
                lineTo(x = 9.19f, y = 6.8f)
                lineTo(x = 9.67f, y = 2.0f)
                horizontalLineTo(x = 6.62f)
                curveTo(x1 = 4.0f, y1 = 2.0f, x2 = 3.0f, y2 = 3.0f, x3 = 2.64f, y3 = 5.6f)
                lineTo(x = 2.36f, y = 8.35f)
                arcTo(horizontalEllipseRadius = 3.26f, verticalEllipseRadius = 3.26f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 5.67f, y1 = 12.0f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
