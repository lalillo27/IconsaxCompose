    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = -4.08f, dy1 = 0.3f, dx2 = -4.07f, dy2 = 6.2f, dx3 = 0.0f, dy3 = 6.5f)
                horizontalLineToRelative(dx = 9.66f)
                arcToRelative(a = 4.7f, b = 4.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 3.17f, dy1 = -1.23f)
