    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 15.34f, y = 15.28f)
                arcToRelative(a = 4.0f, b = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.16f, dy1 = -1.03f)
                moveToRelative(dx = -7.0f, dy = 0.0f)
                arcToRelative(a = 3.52f, b = 3.52f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 4.54f, dy1 = 3.34f)
            ...
            path(
                ...
                lineToRelative(dx = 0.69f, dy = 4.25f)
            }
