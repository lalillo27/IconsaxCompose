    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveToRelative(dx = 2.55f, dy = -14.3f)
                lineToRelative(dx = 4.05f, dy = 4.1f)
                lineToRelative(dx = 6.49f, dy = -7.94f)
                curveToRelative(dx1 = 0.71f, dy1 = -0.87f, dx2 = -0.22f, dy2 = -2.12f, dx3 = -1.26f, dy3 = -1.68f)
                lineTo(x = 8.97f, y = 5.84f)
                arcTo(horizontalEllipseRadius = 1.08f, verticalEllipseRadius = 1.08f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 8.63f, y1 = 7.6f)
                close()
            }
