    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 6.94f, y = 9.42f)
                arcToRelative(a = 2.14f, b = 2.14f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -2.93f, dy1 = 0.0f)
                curveTo(x1 = 2.89f, y1 = 8.35f, x2 = 1.6f, y2 = 6.62f, x3 = 2.07f, y3 = 4.6f)
                curveToRelative(dx1 = 0.8f, dy1 = -3.46f, dx2 = 6.01f, dy2 = -3.46f, dx3 = 6.8f, dy3 = 0.0f)
                arcTo(horizontalEllipseRadius = 4.0f, verticalEllipseRadius = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 8.94f, y1 = 6.0f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineWidth = 1.5f,
            ) {
                moveTo(x = 15.07f, y = 16.6f)
