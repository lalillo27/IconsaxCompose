    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 12.9f, y = 7.94f)
                lineToRelative(dx = 2.62f, dy = 2.62f)
                arcToRelative(a = 2.0f, b = 2.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = 2.8f)
                lineTo(x = 9.0f, y = 19.87f)
                moveTo(x = 9.0f, y = 4.04f)
