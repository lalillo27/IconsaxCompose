    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 0.5f, verticalEllipseRadius = 0.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 3.21f, y1 = 4.0f)
                ...
                arcTo(horizontalEllipseRadius = 0.5f, verticalEllipseRadius = 0.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 11.8f, y1 = 10.0f)
                ...
                arcTo(horizontalEllipseRadius = 0.5f, verticalEllipseRadius = 0.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 11.81f, y1 = 20.0f)
                horizontalLineTo(x = 8.52f)
                arcTo(horizontalEllipseRadius = 6.5f, verticalEllipseRadius = 6.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 5.49f, y1 = 7.75f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
                ...
                lineToRelative(dx = -2.15f, dy = -2.15f)
                arcTo(horizontalEllipseRadius = 0.5f, verticalEllipseRadius = 0.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 12.21f, y1 = 4.0f)
                horizontalLineToRelative(dx = 3.29f)
