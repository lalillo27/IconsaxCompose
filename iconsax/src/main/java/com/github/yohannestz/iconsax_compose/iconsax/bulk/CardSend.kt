...
val CardSend: ImageVector
    get() {
        val current = _cardSend
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.CardSend",
            ...
            path(
                ...
                curveTo(x1 = 20.13f, y1 = 6.72f, x2 = 19.85f, y2 = 7.0f, x3 = 19.5f, y3 = 7.0f)
