...
val TruckRemove: ImageVector
    get() {
        val current = _truckRemove
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.TruckRemove",
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 4.0f, verticalEllipseRadius = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 1.0f, y1 = 5.0f)
                ...
                moveTo(x = 6.07f, y = 6.04f)
                lineTo(x = 3.96f, y = 3.93f)
                moveToRelative(dx = 2.08f, dy = 0.03f)
                lineTo(x = 3.93f, y = 6.07f)
            }
        }.build().also { _truckRemove = it }
    }
