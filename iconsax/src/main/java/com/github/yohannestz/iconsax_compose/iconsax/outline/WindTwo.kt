    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 4.1f, b = 4.1f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -4.23f, dy1 = 0.0f)
                arcToRelative(a = 5.6f, b = 5.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -5.77f, dy1 = 0.0f)
                arcToRelative(a = 4.1f, b = 4.1f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -4.23f, dy1 = 0.0f)
                lineToRelative(dx = -2.5f, dy = 1.5f)
                ...
                moveToRelative(dx = -15.0f, dy = -7.0f)
                curveToRelative(dx1 = -1.0f, dy1 = 0.0f, dx2 = -2.0f, dy2 = -0.27f, dx3 = -2.9f, dy3 = -0.8f)
                lineToRelative(dx = -2.5f, dy = -1.5f)
                ...
                arcToRelative(a = 5.6f, b = 5.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -5.77f, dy1 = 0.0f)
                arcToRelative(a = 4.1f, b = 4.1f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -4.23f, dy1 = 0.0f)
                arcTo(horizontalEllipseRadius = 5.6f, verticalEllipseRadius = 5.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 7.0f, y1 = 6.85f)
