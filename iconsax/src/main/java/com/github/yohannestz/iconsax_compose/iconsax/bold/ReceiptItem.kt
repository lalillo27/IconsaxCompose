    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 18.01f, y = 2.0f)
                verticalLineToRelative(dy = 1.5f)
                arcToRelative(a = 2.5f, b = 2.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.75f, dy1 = 0.72f)
                arcTo(horizontalEllipseRadius = 2.5f, verticalEllipseRadius = 2.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 20.5f, y1 = 6.0f)
                verticalLineToRelative(dy = 2.42f)
                curveToRelative(dx1 = 0.0f, dy1 = 0.74f, dx2 = -0.33f, dy2 = 1.08f, dx3 = -1.08f, dy3 = 1.08f)
                ...
                arcTo(horizontalEllipseRadius = 2.0f, verticalEllipseRadius = 2.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 16.0f, y1 = 4.01f)
                verticalLineTo(y = 11.0f)
                horizontalLineToRelative(dx = 3.42f)
                curveTo(x1 = 21.0f, y1 = 11.0f, x2 = 22.0f, y2 = 10.0f, x3 = 22.0f, y3 = 8.42f)
                verticalLineTo(y = 6.0f)
                curveToRelative(dx1 = 0.0f, dy1 = -1.1f, dx2 = -0.45f, dy2 = -2.1f, dx3 = -1.17f, dy3 = -2.83f)
                arcTo(horizontalEllipseRadius = 4.0f, verticalEllipseRadius = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 18.01f, y1 = 2.0f)
            }
