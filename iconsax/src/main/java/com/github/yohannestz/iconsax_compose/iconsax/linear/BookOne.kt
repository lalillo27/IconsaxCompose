    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 22.0f, y = 16.74f)
                verticalLineTo(y = 4.67f)
                ...
                arcTo(horizontalEllipseRadius = 1.97f, verticalEllipseRadius = 1.97f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 2.0f, y1 = 4.66f)
                verticalLineToRelative(dy = 12.08f)
