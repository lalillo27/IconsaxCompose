...
val EmptyWalletRemove: ImageVector
    get() {
        val current = _emptyWalletRemove
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.EmptyWalletRemove",
            ...
            path(
                ...
                arcToRelative(a = 3.26f, b = 3.26f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -5.28f, dy1 = -2.53f)
                arcToRelative(a = 0.74f, b = 0.74f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -1.21f, dy1 = -0.59f)
                ...
                curveToRelative(dx1 = 0.06f, dy1 = 0.66f, dx2 = 0.69f, dy2 = 1.2f, dx3 = 1.41f, dy3 = 1.2f)
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 4.71f, verticalEllipseRadius = 4.71f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 5.0f, y1 = 14.25f)
                ...
                arcTo(horizontalEllipseRadius = 3.2f, verticalEllipseRadius = 3.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 5.0f, y1 = 22.25f)
        ...
        }.build().also { _emptyWalletRemove = it }
    }
