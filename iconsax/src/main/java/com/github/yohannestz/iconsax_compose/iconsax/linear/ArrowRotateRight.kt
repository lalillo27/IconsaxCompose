    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 8.67f, b = 8.67f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, dx1 = 7.21f, dy1 = 3.86f)
                moveToRelative(dx = -3.08f, dy = -3.19f)
                lineTo(x = 13.24f, y = 2.0f)
