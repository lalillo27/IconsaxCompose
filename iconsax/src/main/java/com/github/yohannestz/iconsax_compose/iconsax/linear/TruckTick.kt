    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 3.9f, b = 3.9f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -1.31f, dy1 = 3.03f)
                arcTo(horizontalEllipseRadius = 3.8f, verticalEllipseRadius = 3.8f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 5.09f, y1 = 9.0f)
                arcToRelative(a = 3.9f, b = 3.9f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -3.46f, dy1 = -1.87f)
            ...
            path(
                ...
                lineToRelative(dx = 2.09f, dy = -2.02f)
            }
