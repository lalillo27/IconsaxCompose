    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 1.3f, b = 1.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.62f, dy1 = -0.31f)
                lineToRelative(dx = 3.7f, dy = -3.71f)
                curveToRelative(dx1 = 0.65f, dy1 = -0.64f, dx2 = 0.95f, dy2 = -1.38f, dx3 = 0.0f, dy3 = -2.32f)
                curveToRelative(dx1 = -0.94f, dy1 = -0.95f, dx2 = -1.68f, dy2 = -0.65f, dx3 = -2.32f, dy3 = -0.01f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
