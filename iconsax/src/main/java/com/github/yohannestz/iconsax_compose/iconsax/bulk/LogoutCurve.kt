    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                horizontalLineToRelative(dx = 10.69f)
                curveToRelative(dx1 = 0.41f, dy1 = 0.0f, dx2 = 0.75f, dy2 = -0.34f, dx3 = 0.75f, dy3 = -0.75f)
                reflectiveCurveToRelative(dx1 = -0.34f, dy1 = -0.75f, dx2 = -0.75f, dy2 = -0.75f)
                horizontalLineTo(x = 4.56f)
                lineToRelative(dx = 2.07f, dy = -2.07f)
                quadToRelative(dx1 = 0.22f, dy1 = -0.23f, dx2 = 0.22f, dy2 = -0.53f)
                curveToRelative(dx1 = 0.0f, dy1 = -0.3f, dx2 = -0.07f, dy2 = -0.39f, dx3 = -0.22f, dy3 = -0.53f)
