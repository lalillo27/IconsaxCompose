    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 15.0f, verticalEllipseRadius = 15.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 15.0f, y1 = 3.91f)
                arcToRelative(a = 20.0f, b = 20.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 4.77f, dy1 = -1.24f)
                horizontalLineToRelative(dx = 0.06f)
                arcToRelative(a = 1.97f, b = 1.97f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 2.17f, dy1 = 2.0f)
            }
            path(
                fillAlpha = 0.4f,
                stroke = SolidColor(Color(0xFF292D32)),
                ...
                moveToRelative(dx = 7.0f, dy = -17.7f)
