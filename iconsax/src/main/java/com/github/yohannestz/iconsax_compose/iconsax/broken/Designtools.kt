    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 18.0f, y = 3.02f)
                arcToRelative(a = 21.0f, b = 21.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.96f, dy1 = -0.92f)
                arcToRelative(a = 1.4f, b = 1.4f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.52f, dy1 = 0.31f)
                arcToRelative(a = 1.4f, b = 1.4f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.32f, dy1 = 1.54f)
                ...
                arcToRelative(a = 32.0f, b = 32.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 6.12f, dy1 = -5.51f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
            ...
            path(
                ...
                moveToRelative(dx = 0.01f, dy = 0.01f)
