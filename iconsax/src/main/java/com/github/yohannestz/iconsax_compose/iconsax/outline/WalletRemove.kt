    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = -0.32f, dy1 = 0.0f, dx2 = -0.6f, dy2 = -0.2f, dx3 = -0.71f, dy3 = -0.49f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.22f, dy1 = -0.83f)
                arcToRelative(a = 3.15f, b = 3.15f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 1.1f, dy1 = -2.42f)
                arcToRelative(a = 3.26f, b = 3.26f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -5.69f, dy1 = -2.14f)
                arcToRelative(a = 0.8f, b = 0.8f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.83f, dy1 = 0.21f)
                arcToRelative(a = 0.8f, b = 0.8f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.49f, dy1 = -0.7f)
                verticalLineTo(y = 12.0f)
                curveToRelative(dx1 = 0.0f, dy1 = -3.08f, dx2 = 1.9f, dy2 = -5.31f, dx3 = 4.85f, dy3 = -5.68f)
                arcToRelative(a = 6.0f, b = 6.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.9f, dy1 = -0.07f)
                ...
                curveToRelative(dx1 = 0.02f, dy1 = 3.44f, dx2 = -2.29f, dy2 = 5.75f, dx3 = -5.73f, dy3 = 5.75f)
                moveToRelative(dx = -7.82f, dy = -1.5f)
                ...
                arcToRelative(a = 4.73f, b = 4.73f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 7.0f, dy1 = 4.18f)
                curveToRelative(dx1 = 0.0f, dy1 = 0.79f, dx2 = -0.2f, dy2 = 1.57f, dx3 = -0.57f, dy3 = 2.25f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
                ...
                lineToRelative(dx = 1.75f, dy = 1.78f)
                ...
                arcTo(horizontalEllipseRadius = 4.0f, verticalEllipseRadius = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 17.0f, y1 = 7.76f)
                horizontalLineTo(x = 7.0f)
                arcToRelative(a = 5.0f, b = 5.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.7f, dy1 = 0.05f)
                close()
                ...
                curveToRelative(dx1 = 0.41f, dy1 = 0.0f, dx2 = 0.75f, dy2 = 0.34f, dx3 = 0.75f, dy3 = 0.75f)
                reflectiveCurveToRelative(dx1 = -0.34f, dy1 = 0.75f, dx2 = -0.75f, dy2 = 0.75f)
                moveToRelative(dx = -17.0f, dy = 6.5f)
                arcToRelative(a = 4.7f, b = 4.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -4.06f, dy1 = -2.31f)
                arcToRelative(a = 4.72f, b = 4.72f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.5f, dy1 = -5.57f)
                arcToRelative(a = 4.73f, b = 4.73f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = true, dx1 = 6.67f, dy1 = 6.7f)
                arcTo(horizontalEllipseRadius = 4.6f, verticalEllipseRadius = 4.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 5.0f, y1 = 23.75f)
                moveToRelative(dx = 0.0f, dy = -8.0f)
                arcToRelative(a = 3.24f, b = 3.24f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -2.78f, dy1 = 4.92f)
                arcTo(horizontalEllipseRadius = 3.24f, verticalEllipseRadius = 3.24f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, x1 = 5.0f, y1 = 15.75f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
                moveTo(x = 6.07f, y = 20.8f)
            ...
            path(
                ...
                moveTo(x = 3.93f, y = 20.82f)
                arcTo(horizontalEllipseRadius = 0.7f, verticalEllipseRadius = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 3.4f, y1 = 20.6f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = -1.06f)
                lineToRelative(dx = 2.11f, dy = -2.11f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.06f, dy1 = 0.0f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = 1.06f)
                lineToRelative(dx = -2.1f, dy = 2.1f)
                arcToRelative(a = 0.7f, b = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.54f, dy1 = 0.23f)
            }
