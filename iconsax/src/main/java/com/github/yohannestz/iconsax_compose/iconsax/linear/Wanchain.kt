    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 16.5f, y = 8.9f)
                lineTo(x = 12.0f, y = 6.2f)
                lineTo(x = 7.5f, y = 8.9f)
                moveToRelative(dx = 0.0f, dy = 0.1f)
                verticalLineToRelative(dy = 6.1f)
                lineToRelative(dx = 4.5f, dy = -2.7f)
                lineToRelative(dx = 4.5f, dy = 2.7f)
                verticalLineTo(y = 9.0f)
                moveToRelative(dx = -2.3f, dy = 7.2f)
                lineTo(x = 12.0f, y = 17.7f)
                lineToRelative(dx = -2.2f, dy = -1.5f)
            }
            path(
                stroke = SolidColor(Color(0xFF17191C)),
                strokeLineCap = StrokeCap.Round,
