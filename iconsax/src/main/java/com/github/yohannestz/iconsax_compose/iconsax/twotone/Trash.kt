    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 18.85f, y = 9.14f)
                lineTo(x = 18.2f, y = 19.21f)
                curveTo(x1 = 18.09f, y1 = 20.78f, x2 = 18.0f, y2 = 22.0f, x3 = 15.21f, y3 = 22.0f)
            ...
            path(
                ...
                moveTo(x = 10.33f, y = 16.5f)
                horizontalLineToRelative(dx = 3.33f)
                moveToRelative(dx = -4.16f, dy = -4.0f)
