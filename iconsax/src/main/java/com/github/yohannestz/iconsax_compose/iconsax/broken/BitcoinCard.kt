    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 0.0f, dy1 = 3.5f, dx2 = -0.89f, dy2 = 4.39f, dx3 = -4.44f, dy3 = 4.39f)
                horizontalLineTo(x = 6.44f)
                curveTo(x1 = 2.89f, y1 = 20.5f, x2 = 2.0f, y2 = 19.62f, x3 = 2.0f, y3 = 16.1f)
