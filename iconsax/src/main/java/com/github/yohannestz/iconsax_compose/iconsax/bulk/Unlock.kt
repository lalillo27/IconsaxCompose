    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 4.33f, dy1 = 0.0f, dx2 = 4.88f, dy2 = 2.11f, dx3 = 4.88f, dy3 = 3.95f)
                arcToRelative(a = 0.7f, b = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.7f, dy1 = 0.7f)
                arcToRelative(a = 0.7f, b = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.7f, dy1 = -0.7f)
                quadTo(x1 = 18.27f, y1 = 2.01f, x2 = 12.0f, y2 = 2.0f)
                curveTo(x1 = 6.37f, y1 = 2.0f, x2 = 5.72f, y2 = 5.58f, x3 = 5.72f, y3 = 8.28f)
