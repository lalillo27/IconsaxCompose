    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 0.54f, dy1 = -1.24f, dx2 = -0.1f, dy2 = -1.83f, dx3 = -1.36f, dy3 = -1.3f)
                arcToRelative(a = 10.3f, b = 10.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -6.34f, dy1 = 10.23f)
            }
        }.build().also { _moon = it }
    }
