    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 0.0f, dy1 = -1.84f, dx2 = -0.56f, dy2 = -2.4f, dx3 = -2.4f, dy3 = -2.4f)
                close()
                moveToRelative(dx = 9.85f, dy = 9.0f)
                ...
                moveToRelative(dx = 15.5f, dy = 2.0f)
                arcToRelative(a = 5.26f, b = 5.26f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = -10.5f)
                arcToRelative(a = 5.26f, b = 5.26f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = 10.5f)
