    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 19.29f, y = 7.7f)
                lineTo(x = 11.9f, y = 15.1f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.19f, dy1 = 1.56f)
                lineToRelative(dx = 7.39f, dy = 4.43f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 1.51f, dy1 = -0.86f)
                verticalLineTo(y = 8.41f)
                curveToRelative(dx1 = 0.01f, dy1 = -0.89f, dx2 = -1.07f, dy2 = -1.33f, dx3 = -1.7f, dy3 = -0.7f)
            }
