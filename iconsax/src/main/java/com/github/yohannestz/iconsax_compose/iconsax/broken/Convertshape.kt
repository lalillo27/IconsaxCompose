    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 18.85f, y = 2.0f)
                horizontalLineToRelative(dx = -2.7f)
                curveTo(x1 = 13.9f, y1 = 2.0f, x2 = 13.0f, y2 = 2.9f, x3 = 13.0f, y3 = 5.15f)
                verticalLineToRelative(dy = 3.7f)
                curveTo(x1 = 13.0f, y1 = 11.1f, x2 = 13.9f, y2 = 12.0f, x3 = 16.15f, y3 = 12.0f)
                horizontalLineToRelative(dx = 2.7f)
                curveTo(x1 = 21.1f, y1 = 12.0f, x2 = 22.0f, y2 = 11.1f, x3 = 22.0f, y3 = 8.85f)
                verticalLineTo(y = 5.96f)
                moveTo(x = 5.15f, y = 22.0f)
                horizontalLineToRelative(dx = 2.7f)
                curveTo(x1 = 10.1f, y1 = 22.0f, x2 = 11.0f, y2 = 21.1f, x3 = 11.0f, y3 = 18.85f)
                verticalLineToRelative(dy = -3.7f)
                curveTo(x1 = 11.0f, y1 = 12.9f, x2 = 10.1f, y2 = 12.0f, x3 = 7.85f, y3 = 12.0f)
                horizontalLineToRelative(dx = -2.7f)
                curveTo(x1 = 2.9f, y1 = 12.0f, x2 = 2.0f, y2 = 12.9f, x3 = 2.0f, y3 = 15.15f)
