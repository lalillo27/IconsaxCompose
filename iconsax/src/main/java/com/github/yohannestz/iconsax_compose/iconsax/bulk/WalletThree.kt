    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 3.7f, b = 3.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 3.69f, dy1 = -3.7f)
                horizontalLineToRelative(dx = 5.62f)
                curveToRelative(dx1 = 2.04f, dy1 = 0.0f, dx2 = 3.69f, dy2 = 1.26f, dx3 = 3.69f, dy3 = 3.3f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
                fillAlpha = 0.4f,
            ...
            path(
                ...
                moveToRelative(dx = -9.0f, dy = -0.72f)
                horizontalLineTo(x = 7.0f)
                curveToRelative(dx1 = -0.41f, dy1 = 0.0f, dx2 = -0.75f, dy2 = -0.34f, dx3 = -0.75f, dy3 = -0.75f)
                reflectiveCurveTo(x1 = 6.59f, y1 = 10.4f, x2 = 7.0f, y2 = 10.4f)
                horizontalLineToRelative(dx = 6.0f)
                curveToRelative(dx1 = 0.41f, dy1 = 0.0f, dx2 = 0.75f, dy2 = 0.34f, dx3 = 0.75f, dy3 = 0.75f)
                reflectiveCurveTo(x1 = 13.41f, y1 = 11.9f, x2 = 13.0f, y2 = 11.9f)
            }
