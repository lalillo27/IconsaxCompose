...
val ExportSquare: ImageVector
    get() {
        val current = _exportSquare
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.ExportSquare",
            ...
            path(
                ...
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = 1.06f)
                lineToRelative(dx = -8.2f, dy = 8.2f)
                arcTo(horizontalEllipseRadius = 0.7f, verticalEllipseRadius = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 13.0f, y1 = 11.75f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
                ...
                arcTo(horizontalEllipseRadius = 0.76f, verticalEllipseRadius = 0.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 22.0f, y1 = 7.55f)
                moveToRelative(dx = -7.0f, dy = 15.2f)
        ...
        }.build().also { _exportSquare = it }
    }

@Suppress("ObjectPropertyName")
private var _exportSquare: ImageVector? = null
