    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 12.64f, y = 8.52f)
                lineToRelative(dx = 4.85f, dy = 1.23f)
                moveToRelative(dx = -5.83f, dy = 2.64f)
            ...
            path(
                ...
                moveTo(x = 20.96f, y = 5.1f)
                curveToRelative(dx1 = 1.08f, dy1 = 1.2f, dx2 = 1.27f, dy2 = 2.92f, dx3 = 0.7f, dy3 = 5.34f)
                lineToRelative(dx = -0.98f, dy = 4.18f)
