    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 3.12f, b = 3.12f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 5.8f, dy1 = -1.57f)
                moveToRelative(dx = -8.17f, dy = -4.9f)
                curveToRelative(dx1 = 3.54f, dy1 = -2.79f, dx2 = 9.2f, dy2 = -2.4f, dx3 = 12.17f, dy3 = 1.14f)
                moveTo(x = 6.0f, y = 17.81f)
