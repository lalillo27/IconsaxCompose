    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 5.08f, dy = 12.16f)
                ...
                moveToRelative(dx = -2.75f, dy = 2.4f)
                ...
                arcToRelative(a = 0.63f, b = 0.63f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.88f, dy1 = 0.0f)
                arcToRelative(a = 0.6f, b = 0.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = 0.88f)
            }
