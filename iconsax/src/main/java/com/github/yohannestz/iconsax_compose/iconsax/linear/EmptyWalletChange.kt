    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 4.22f, y = 15.28f)
                lineTo(x = 3.0f, y = 16.5f)
                lineToRelative(dx = 1.22f, dy = 1.22f)
                moveToRelative(dx = 5.28f, dy = 4.06f)
                horizontalLineTo(x = 4.16f)
                arcTo(horizontalEllipseRadius = 1.16f, verticalEllipseRadius = 1.16f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 3.0f, y1 = 20.62f)
                verticalLineToRelative(dy = -1.28f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
