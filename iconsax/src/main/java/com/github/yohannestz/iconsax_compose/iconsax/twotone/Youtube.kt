    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 11.42f, y = 9.49f)
                lineToRelative(dx = 2.47f, dy = 1.48f)
                curveToRelative(dx1 = 0.94f, dy1 = 0.57f, dx2 = 0.94f, dy2 = 1.49f, dx3 = 0.0f, dy3 = 2.06f)
                lineToRelative(dx = -2.47f, dy = 1.48f)
                curveToRelative(dx1 = -1.0f, dy1 = 0.6f, dx2 = -1.82f, dy2 = 0.14f, dx3 = -1.82f, dy3 = -1.03f)
                verticalLineToRelative(dy = -2.97f)
                curveToRelative(dx1 = 0.0f, dy1 = -1.16f, dx2 = 0.82f, dy2 = -1.62f, dx3 = 1.82f, dy3 = -1.02f)
            }
