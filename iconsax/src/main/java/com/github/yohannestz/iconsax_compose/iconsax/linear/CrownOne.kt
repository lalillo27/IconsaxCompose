    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(dx = 3.66f, dy = -2.61f)
                curveToRelative(dx1 = 1.56f, dy1 = -1.12f, dx2 = 2.31f, dy2 = -0.55f, dx3 = 1.67f, dy3 = 1.26f)
                lineToRelative(dx = -4.04f, dy = 11.31f)
                arcToRelative(a = 1.2f, b = 1.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -1.04f, dy1 = 0.71f)
