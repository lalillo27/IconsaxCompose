    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = -8.5f, dy = 8.5f)
                ...
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = 1.06f)
                lineToRelative(dx = -2.0f, dy = 2.0f)
                arcTo(horizontalEllipseRadius = 0.7f, verticalEllipseRadius = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 14.0f, y1 = 17.75f)
            }
