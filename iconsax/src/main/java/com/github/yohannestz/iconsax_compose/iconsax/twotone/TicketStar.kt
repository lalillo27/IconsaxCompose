    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 3.15f, y1 = 4.0f, x2 = 2.1f, y2 = 4.92f, x3 = 2.0f, y3 = 8.5f)
                arcToRelative(a = 3.5f, b = 3.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = 7.0f)
                curveTo(x1 = 2.1f, y1 = 19.08f, x2 = 3.16f, y2 = 20.0f, x3 = 7.0f, y3 = 20.0f)
            ...
            path(
                ...
                moveToRelative(dx = 6.02f, dy = -10.67f)
