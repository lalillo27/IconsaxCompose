    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 7.8f, y = 10.2f)
                verticalLineToRelative(dy = 4.2f)
                moveToRelative(dx = 0.15f, dy = -4.5f)
            ...
            path(
                ...
                moveTo(x = 7.88f, y = 10.2f)
                arcToRelative(a = 2.4f, b = 2.4f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 2.36f, dy1 = 1.82f)
                lineToRelative(dx = 2.06f, dy = -0.01f)
                arcToRelative(a = 3.6f, b = 3.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 3.4f, dy1 = 2.41f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
