    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineTo(x = 7.6f, y = 2.0f)
                lineTo(x = 2.0f, y = 6.0f)
                lineToRelative(dx = 4.4f, dy = 3.0f)
                close()
                ...
                moveToRelative(dx = 0.0f, dy = 0.0f)
                lineToRelative(dx = 4.4f, dy = 3.0f)
                lineToRelative(dx = 5.6f, dy = -4.0f)
                lineToRelative(dx = -4.4f, dy = -3.0f)
                close()
            }
            path(
                ...
                lineToRelative(dx = -6.6f, dy = 3.0f)
                curveToRelative(dx1 = -0.3f, dy1 = 0.1f, dx2 = -0.6f, dy2 = 0.1f, dx3 = -0.8f, dy3 = 0.0f)
                lineToRelative(dx = -6.6f, dy = -3.0f)
                verticalLineToRelative(dy = -3.3f)
            }
