    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveTo(x1 = 16.75f, y1 = 2.91f, x2 = 16.35f, y2 = 2.0f, x3 = 14.55f, y3 = 2.0f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
                ...
                moveTo(x = 19.16f, y = 13.43f)
                lineToRelative(dx = 0.08f, dy = 0.9f)
                arcToRelative(a = 1.46f, b = 1.46f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -1.47f, dy1 = 1.57f)
