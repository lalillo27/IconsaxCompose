    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 6.65f, y = 15.97f)
                lineToRelative(dx = 3.53f, dy = -7.94f)
                lineToRelative(dx = 2.64f, dy = 7.94f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineMiter = 10.0f,
