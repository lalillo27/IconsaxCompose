...
val CalendarAdd: ImageVector
    get() {
        ...
        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.CalendarAdd",
            ...
            path(
                ...
                moveTo(x = 21.0f, y = 10.84f)
                verticalLineToRelative(dy = 1.74f)
                arcToRelative(a = 0.98f, b = 0.98f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -1.14f, dy1 = 0.98f)
                arcTo(horizontalEllipseRadius = 6.0f, verticalEllipseRadius = 6.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 19.0f, y1 = 13.49f)
                arcToRelative(a = 5.5f, b = 5.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -5.5f, dy1 = 5.5f)
                curveToRelative(dx1 = 0.0f, dy1 = 0.46f, dx2 = 0.18f, dy2 = 1.1f, dx3 = 0.37f, dy3 = 1.68f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.95f, dy1 = 1.32f)
            ...
            path(
                ...
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.29f, dy1 = 0.7f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.71f, dy1 = 0.3f)
                moveToRelative(dx = 13.33f, dy = -2.33f)
                ...
                arcToRelative(a = 4.0f, b = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 5.66f, dy1 = 0.0f)
                arcToRelative(a = 4.0f, b = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.0f, dy1 = -5.66f)
                moveToRelative(dx = -0.76f, dy = 3.39f)
                ...
                quadToRelative(dx1 = 0.0f, dy1 = 0.32f, dx2 = -0.22f, dy2 = 0.53f)
                curveToRelative(dx1 = -0.22f, dy1 = 0.21f, dx2 = -0.32f, dy2 = 0.22f, dx3 = -0.53f, dy3 = 0.22f)
