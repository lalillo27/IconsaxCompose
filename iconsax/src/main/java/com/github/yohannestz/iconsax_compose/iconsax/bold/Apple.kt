    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 6.0f, verticalEllipseRadius = 6.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 8.59f, y1 = 7.0f)
                arcTo(horizontalEllipseRadius = 5.1f, verticalEllipseRadius = 5.1f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 4.5f, y1 = 9.47f)
                ...
                curveToRelative(dx1 = 1.45f, dy1 = -0.02f, dx2 = 2.61f, dy2 = -1.58f, dx3 = 3.43f, dy3 = -2.84f)
