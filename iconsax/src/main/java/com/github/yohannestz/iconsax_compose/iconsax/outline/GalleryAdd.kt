    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 21.25f, y = 5.75f)
                horizontalLineToRelative(dx = -5.5f)
                curveTo(x1 = 15.34f, y1 = 5.75f, x2 = 15.0f, y2 = 5.41f, x3 = 15.0f, y3 = 5.0f)
                reflectiveCurveToRelative(dx1 = 0.34f, dy1 = -0.75f, dx2 = 0.75f, dy2 = -0.75f)
                horizontalLineToRelative(dx = 5.5f)
                curveTo(x1 = 21.66f, y1 = 4.25f, x2 = 22.0f, y2 = 4.59f, x3 = 22.0f, y3 = 5.0f)
                reflectiveCurveToRelative(dx1 = -0.34f, dy1 = 0.75f, dx2 = -0.75f, dy2 = 0.75f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
                ...
                reflectiveCurveToRelative(dx1 = 0.75f, dy1 = 0.34f, dx2 = 0.75f, dy2 = 0.75f)
                verticalLineToRelative(dy = 5.5f)
                arcTo(horizontalEllipseRadius = 0.76f, verticalEllipseRadius = 0.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 18.5f, y1 = 8.5f)
