    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 5.12f, dy = 0.0f)
                arcToRelative(a = 0.76f, b = 0.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.75f, dy1 = -0.75f)
                verticalLineTo(y = 14.0f)
                curveToRelative(dx1 = 0.0f, dy1 = -0.41f, dx2 = 0.34f, dy2 = -0.75f, dx3 = 0.75f, dy3 = -0.75f)
                reflectiveCurveToRelative(dx1 = 0.75f, dy1 = 0.34f, dx2 = 0.75f, dy2 = 0.75f)
                verticalLineToRelative(dy = 4.15f)
                arcTo(horizontalEllipseRadius = 0.75f, verticalEllipseRadius = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 12.0f, y1 = 18.9f)
                moveToRelative(dx = 5.12f, dy = 0.0f)
                arcToRelative(a = 0.76f, b = 0.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.75f, dy1 = -0.75f)
                ...
                moveToRelative(dx = 0.75f, dy = -13.08f)
                lineToRelative(dx = -0.03f, dy = -0.16f)
                lineToRelative(dx = -0.03f, dy = -0.13f)
                lineToRelative(dx = -0.07f, dy = -0.1f)
                quadToRelative(dx1 = -0.04f, dy1 = -0.08f, dx2 = -0.1f, dy2 = -0.13f)
                quadToRelative(dx1 = 0.0f, dy1 = -0.01f, dx2 = -0.02f, dy2 = -0.02f)
                lineToRelative(dx = -0.09f, dy = -0.05f)
                lineToRelative(dx = -0.14f, dy = -0.08f)
                ...
                reflectiveCurveTo(x1 = 13.8f, y1 = 6.6f, x2 = 14.2f, y2 = 6.6f)
                horizontalLineToRelative(dx = 1.25f)
                arcToRelative(a = 18.0f, b = 18.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -8.75f, dy1 = 5.11f)
                arcToRelative(a = 0.76f, b = 0.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.55f, dy1 = 0.91f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.73f, dy1 = 0.57f)
                quadToRelative(dx1 = 0.09f, dy1 = 0.0f, dx2 = 0.18f, dy2 = -0.02f)
                arcToRelative(a = 19.5f, b = 19.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 9.31f, dy1 = -5.36f)
