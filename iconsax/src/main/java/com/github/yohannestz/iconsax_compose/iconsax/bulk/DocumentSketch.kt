    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(x = 12.55f, y = 14.0f)
                lineToRelative(dx = -0.85f, dy = -1.28f)
                arcToRelative(a = 1.3f, b = 1.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.04f, dy1 = -0.56f)
                horizontalLineTo(x = 8.64f)
                arcToRelative(a = 1.3f, b = 1.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.04f, dy1 = 0.56f)
                lineTo(x = 6.75f, y = 14.0f)
                arcToRelative(a = 1.3f, b = 1.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.15f, dy1 = 1.58f)
                lineToRelative(dx = 1.86f, dy = 1.86f)
                arcToRelative(a = 1.3f, b = 1.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 1.78f, dy1 = 0.0f)
                lineToRelative(dx = 1.86f, dy = -1.86f)
                arcTo(horizontalEllipseRadius = 1.3f, verticalEllipseRadius = 1.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 12.55f, y1 = 14.0f)
            }
