    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 18.57f, y = 8.0f)
                horizontalLineTo(x = 14.0f)
                quadToRelative(dx1 = -3.43f, dy1 = 0.0f, dx2 = -3.43f, dy2 = 3.43f)
                verticalLineToRelative(dy = 7.14f)
                quadTo(x1 = 10.57f, y1 = 22.0f, x2 = 14.0f, y2 = 22.0f)
                horizontalLineToRelative(dx = 4.57f)
                quadTo(x1 = 22.0f, y1 = 22.0f, x2 = 22.0f, y2 = 18.57f)
                verticalLineToRelative(dy = -7.14f)
                quadTo(x1 = 22.0f, y1 = 8.0f, x2 = 18.57f, y2 = 8.0f)
                moveToRelative(dx = -0.44f, dy = 7.75f)
