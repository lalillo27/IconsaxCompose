    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = -4.44f, dy = -12.0f)
                ...
                moveToRelative(dx = -7.74f, dy = 0.0f)
            ...
            path(
                ...
                moveTo(x = 20.47f, y = 14.0f)
                horizontalLineToRelative(dx = -0.45f)
                arcToRelative(a = 1.35f, b = 1.35f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.35f, dy1 = 1.35f)
                ...
                arcToRelative(a = 1.35f, b = 1.35f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -2.7f, dy1 = 0.0f)
                verticalLineToRelative(dy = -0.31f)
                arcTo(horizontalEllipseRadius = 1.3f, verticalEllipseRadius = 1.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 9.26f, y1 = 14.0f)
                arcToRelative(a = 1.35f, b = 1.35f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.35f, dy1 = 1.35f)
                moveToRelative(dx = -4.38f, dy = -1.37f)
