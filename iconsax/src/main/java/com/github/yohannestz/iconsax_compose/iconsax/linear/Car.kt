    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(dx = -1.13f, dy = -5.41f)
                ...
                lineToRelative(dx = -0.2f, dy = 0.6f)
                curveTo(x1 = 7.15f, y1 = 21.54f, x2 = 7.0f, y2 = 22.0f, x3 = 5.92f, y3 = 22.0f)
                horizontalLineTo(x = 4.04f)
                arcToRelative(a = 2.0f, b = 2.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -2.03f, dy1 = -2.18f)
                lineToRelative(dx = 0.56f, dy = -6.09f)
                curveTo(x1 = 2.71f, y1 = 12.23f, x2 = 3.0f, y2 = 11.0f, x3 = 5.62f, y3 = 11.0f)
                horizontalLineToRelative(dx = 12.76f)
                curveToRelative(dx1 = 2.62f, dy1 = 0.0f, dx2 = 2.91f, dy2 = 1.23f, dx3 = 3.05f, dy3 = 2.73f)
                close()
