...
val GalleryExport: ImageVector
    get() {
        val current = _galleryExport
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.GalleryExport",
