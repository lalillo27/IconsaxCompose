    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 4.5f, dy = 4.09f)
            ...
            path(
                ...
                arcTo(horizontalEllipseRadius = 1.0f, verticalEllipseRadius = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 7.5f, y1 = 13.5f)
                ...
                lineToRelative(dx = -0.12f, dy = -0.14f)
                lineToRelative(dx = -0.09f, dy = -0.18f)
                lineToRelative(dx = -0.06f, dy = -0.18f)
                ...
                arcTo(horizontalEllipseRadius = 1.0f, verticalEllipseRadius = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 13.0f, y1 = 13.5f)
                lineToRelative(dx = -0.02f, dy = 0.2f)
                lineToRelative(dx = -0.06f, dy = 0.18f)
                lineToRelative(dx = -0.09f, dy = 0.18f)
                lineToRelative(dx = -0.12f, dy = 0.15f)
                ...
                quadToRelative(dx1 = 0.07f, dy1 = 0.08f, dx2 = 0.12f, dy2 = 0.16f)
                lineToRelative(dx = 0.09f, dy = 0.18f)
                lineToRelative(dx = 0.06f, dy = 0.19f)
                lineTo(x = 9.5f, y = 17.0f)
