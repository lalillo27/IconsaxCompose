    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 8.38f, y = 12.0f)
                lineToRelative(dx = 2.41f, dy = 2.42f)
                lineToRelative(dx = 4.83f, dy = -4.84f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
                ...
                arcTo(horizontalEllipseRadius = 2.2f, verticalEllipseRadius = 2.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 9.17f, y1 = 3.8f)
                close()
            }
