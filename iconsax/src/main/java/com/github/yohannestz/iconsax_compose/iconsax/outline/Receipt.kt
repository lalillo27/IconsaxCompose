    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 2.6f, b = 2.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -2.06f, dy1 = -1.1f)
                lineTo(x = 8.93f, y = 20.3f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.79f, dy1 = -0.46f)
                arcToRelative(a = 1.1f, b = 1.1f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.84f, dy1 = 0.37f)
                lineTo(x = 6.73f, y = 19.7f)
                lineToRelative(dx = 0.55f, dy = 0.51f)
                curveToRelative(dx1 = -1.44f, dy1 = 1.54f, dx2 = -2.55f, dy2 = 1.42f, dx3 = -3.08f, dy3 = 1.21f)
                ...
                horizontalLineToRelative(dx = 7.56f)
                ...
                quadToRelative(dx1 = -0.37f, dy1 = -0.4f, dx2 = -0.85f, dy2 = -0.37f)
                ...
                curveToRelative(dx1 = 0.76f, dy1 = 0.81f, dx2 = 1.26f, dy2 = 0.91f, dx3 = 1.43f, dy3 = 0.84f)
                ...
                curveToRelative(dx1 = 0.17f, dy1 = 0.07f, dx2 = 0.67f, dy2 = -0.03f, dx3 = 1.43f, dy3 = -0.84f)
                arcToRelative(a = 2.7f, b = 2.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.9f, dy1 = -0.85f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
