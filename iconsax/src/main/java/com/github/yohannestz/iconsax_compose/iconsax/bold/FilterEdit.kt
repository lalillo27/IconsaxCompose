    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 0.0f, dy1 = 0.41f, dx2 = -0.47f, dy2 = 0.66f, dx3 = -0.84f, dy3 = 0.47f)
                arcToRelative(a = 6.0f, b = 6.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -2.86f, dy1 = -0.7f)
                arcToRelative(a = 6.25f, b = 6.25f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -3.39f, dy1 = 11.48f)
                lineToRelative(dx = 0.52f, dy = 0.31f)
                arcTo(horizontalEllipseRadius = 0.5f, verticalEllipseRadius = 0.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 14.3f, y1 = 17.0f)
