    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = -1.15f, dy1 = -1.15f, dx2 = -2.72f, dy2 = -1.09f, dx3 = -3.49f, dy3 = 0.14f)
                lineToRelative(dx = -1.69f, dy = 2.67f)
                lineToRelative(dx = 5.4f, dy = 5.4f)
                lineToRelative(dx = 2.67f, dy = -1.69f)
                curveToRelative(dx1 = 1.15f, dy1 = -0.73f, dx2 = 1.22f, dy2 = -2.41f, dx3 = 0.14f, dy3 = -3.49f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
                ...
                curveToRelative(dx1 = 2.09f, dy1 = -0.25f, dx2 = 2.85f, dy2 = -1.01f, dx3 = 2.63f, dy3 = -3.2f)
