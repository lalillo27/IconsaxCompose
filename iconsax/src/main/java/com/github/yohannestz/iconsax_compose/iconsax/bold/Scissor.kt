    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineTo(x = 8.45f, y = 6.89f)
                arcTo(horizontalEllipseRadius = 0.76f, verticalEllipseRadius = 0.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 7.4f, y1 = 7.04f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.15f, dy1 = 1.05f)
                lineToRelative(dx = 5.2f, dy = 3.89f)
                lineToRelative(dx = -5.9f, dy = 4.42f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.9f, dy1 = 1.2f)
                lineTo(x = 14.0f, y = 12.92f)
                lineToRelative(dx = 7.55f, dy = 5.65f)
                arcTo(horizontalEllipseRadius = 0.7f, verticalEllipseRadius = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 22.0f, y1 = 18.72f)
