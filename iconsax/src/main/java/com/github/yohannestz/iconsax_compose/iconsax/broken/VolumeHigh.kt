    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 1.83f, dy = 2.5f)
                arcTo(horizontalEllipseRadius = 10.8f, verticalEllipseRadius = 10.8f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 22.0f, y1 = 12.0f)
                moveToRelative(dx = -2.17f, dy = -6.5f)
                arcToRelative(a = 11.0f, b = 11.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.4f, dy1 = 2.5f)
            }
