    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 7.49f, y = 3.07f)
                arcToRelative(a = 10.0f, b = 10.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -5.28f, dy1 = 6.91f)
                moveToRelative(dx = 19.6f, dy = 0.08f)
