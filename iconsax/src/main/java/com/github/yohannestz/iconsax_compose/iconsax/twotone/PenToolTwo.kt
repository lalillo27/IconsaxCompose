    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 7.67f, b = 7.67f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -6.77f, dy1 = 7.6f)
                moveToRelative(dx = 16.5f, dy = 0.0f)
                arcToRelative(a = 7.7f, b = 7.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -6.73f, dy1 = -7.6f)
            }
