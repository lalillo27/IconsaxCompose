    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 2.0f, b = 2.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.74f, dy1 = 1.51f)
                ...
                lineTo(x = 4.28f, y = 6.43f)
                curveTo(x1 = 3.69f, y1 = 4.53f, x2 = 4.75f, y2 = 3.48f, x3 = 6.64f, y3 = 4.1f)
                ...
                curveToRelative(dx1 = 1.66f, dy1 = -1.2f, dx2 = 2.99f, dy2 = -0.5f, dx3 = 2.95f, dy3 = 1.55f)
            }
            path(
                fillAlpha = 0.4f,
                stroke = SolidColor(Color(0xFF292D32)),
