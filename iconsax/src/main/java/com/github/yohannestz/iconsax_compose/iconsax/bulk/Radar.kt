    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineTo(x = 6.25f, y = 9.56f)
                arcTo(horizontalEllipseRadius = 6.25f, verticalEllipseRadius = 6.25f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, x1 = 18.26f, y1 = 12.0f)
                ...
                arcToRelative(a = 7.7f, b = 7.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 4.65f, dy1 = -1.55f)
                curveToRelative(dx1 = 4.27f, dy1 = 0.0f, dx2 = 7.75f, dy2 = 3.48f, dx3 = 7.75f, dy3 = 7.75f)
                reflectiveCurveToRelative(dx1 = -3.49f, dy1 = 7.75f, dx2 = -7.76f, dy2 = 7.75f)
            }
