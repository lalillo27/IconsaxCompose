    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 0.47f, dy = 9.25f)
                lineToRelative(dx = -1.62f, dy = 1.02f)
                lineToRelative(dx = 0.14f, dy = 2.4f)
                curveToRelative(dx1 = 0.13f, dy1 = 1.34f, dx2 = -0.33f, dy2 = 1.8f, dx3 = -1.6f, dy3 = 1.95f)
                lineToRelative(dx = -5.07f, dy = 0.6f)
                curveToRelative(dx1 = -0.28f, dy1 = 0.04f, dx2 = -0.37f, dy2 = -0.28f, dx3 = -0.17f, dy3 = -0.48f)
                lineToRelative(dx = 1.54f, dy = -1.54f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.0f, dy1 = -1.06f)
                arcToRelative(a = 0.77f, b = 0.77f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.07f, dy1 = 0.0f)
                lineToRelative(dx = -1.53f, dy = 1.54f)
                curveToRelative(dx1 = -0.2f, dy1 = 0.2f, dx2 = -0.52f, dy2 = 0.1f, dx3 = -0.48f, dy3 = -0.17f)
                lineToRelative(dx = 0.59f, dy = -5.07f)
