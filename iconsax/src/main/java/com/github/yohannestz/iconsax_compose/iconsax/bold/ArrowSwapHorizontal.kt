    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 1.5f, dy = 12.05f)
                ...
                reflectiveCurveTo(x1 = 6.59f, y1 = 13.01f, x2 = 7.0f, y2 = 13.01f)
                ...
                arcToRelative(a = 0.8f, b = 0.8f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.01f, dy1 = 0.57f)
                moveTo(x = 17.0f, y = 10.99f)
                horizontalLineTo(x = 7.0f)
                ...
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.17f, dy1 = -0.24f)
                lineToRelative(dx = 2.95f, dy = -2.95f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.06f, dy1 = 0.0f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = 1.06f)
                lineTo(x = 8.81f, y = 9.49f)
