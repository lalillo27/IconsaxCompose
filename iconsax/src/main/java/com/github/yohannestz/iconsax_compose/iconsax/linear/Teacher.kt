    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(dx = -5.99f, dy = -3.93f)
                arcToRelative(a = 3.9f, b = 3.9f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -3.94f, dy1 = -0.01f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
                ...
                lineToRelative(dx = -0.01f, dy = 4.69f)
                ...
                arcToRelative(a = 4.0f, b = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 2.02f, dy1 = 0.0f)
                lineToRelative(dx = 3.19f, dy = -1.06f)
                arcToRelative(a = 3.4f, b = 3.4f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 2.18f, dy1 = -3.03f)
