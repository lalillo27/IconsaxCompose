    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 3.95f, dy = -15.64f)
                ...
                moveToRelative(dx = -5.49f, dy = 5.26f)
                lineToRelative(dx = -1.07f, dy = 1.86f)
                arcTo(horizontalEllipseRadius = 0.8f, verticalEllipseRadius = 0.8f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 12.0f, y1 = 13.86f)
                ...
                horizontalLineToRelative(dx = 0.84f)
                curveToRelative(dx1 = 0.5f, dy1 = 0.0f, dx2 = 0.91f, dy2 = 0.22f, dx3 = 1.13f, dy3 = 0.6f)
                arcToRelative(a = 1.3f, b = 1.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.05f, dy1 = 1.27f)
            }
