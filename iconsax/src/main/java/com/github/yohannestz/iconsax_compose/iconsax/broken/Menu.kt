    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 8.92f, y = 5.85f)
                arcToRelative(a = 2.46f, b = 2.46f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, dx1 = -2.46f, dy1 = 2.46f)
                moveToRelative(dx = 11.08f, dy = 12.31f)
                arcToRelative(a = 2.46f, b = 2.46f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, dx1 = -2.46f, dy1 = -2.46f)
                moveToRelative(dx = -8.62f, dy = 2.45f)
                arcToRelative(a = 2.46f, b = 2.46f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, dx1 = 0.0f, dy1 = -4.92f)
                arcToRelative(a = 2.46f, b = 2.46f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.0f, dy1 = 4.92f)
            }
        }.build().also { _menu = it }
