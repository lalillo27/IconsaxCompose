    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 9.03f, y = 21.7f)
                lineToRelative(dx = 2.33f, dy = -1.97f)
                ...
                verticalLineTo(y = 12.9f)
                curveToRelative(dx1 = 0.0f, dy1 = -0.42f, dx2 = 0.3f, dy2 = -0.62f, dx3 = 0.7f, dy3 = -0.46f)
                lineToRelative(dx = 4.9f, dy = 2.12f)
                curveToRelative(dx1 = 0.78f, dy1 = 0.33f, dx2 = 1.4f, dy2 = -0.08f, dx3 = 1.4f, dy3 = -0.92f)
                verticalLineToRelative(dy = -1.29f)
                arcToRelative(a = 2.0f, b = 2.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.11f, dy1 = -1.7f)
                lineToRelative(dx = -5.6f, dy = -2.4f)
                arcTo(horizontalEllipseRadius = 0.6f, verticalEllipseRadius = 0.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 14.0f, y1 = 7.78f)
                verticalLineToRelative(dy = -3.0f)
                arcToRelative(a = 3.0f, b = 3.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.52f, dy1 = -2.48f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.95f, dy1 = 0.0f)
                arcToRelative(a = 3.1f, b = 3.1f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.53f, dy1 = 2.5f)
                verticalLineToRelative(dy = 3.0f)
                arcToRelative(a = 0.6f, b = 0.6f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.3f, dy1 = 0.45f)
                lineTo(x = 4.1f, y = 10.67f)
                ...
                lineToRelative(dx = 4.9f, dy = -2.12f)
                curveToRelative(dx1 = 0.39f, dy1 = -0.17f, dx2 = 0.7f, dy2 = 0.04f, dx3 = 0.7f, dy3 = 0.46f)
                verticalLineToRelative(dy = 2.85f)
                arcToRelative(a = 1.2f, b = 1.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.28f, dy1 = 0.71f)
                lineToRelative(dx = -2.27f, dy = 2.28f)
                arcToRelative(a = 1.1f, b = 1.1f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.24f, dy1 = 1.03f)
                lineToRelative(dx = 0.44f, dy = 1.33f)
