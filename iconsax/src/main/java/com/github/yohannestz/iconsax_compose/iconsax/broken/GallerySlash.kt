    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 2.19f, dy1 = 0.0f, dx2 = 3.8f, dy2 = 0.38f, dx3 = 4.92f, dy3 = 1.23f)
                moveTo(x = 3.37f, y = 20.1f)
                curveTo(x1 = 2.43f, y1 = 18.97f, x2 = 2.0f, y2 = 17.3f, x3 = 2.0f, y3 = 15.0f)
                verticalLineToRelative(dy = -2.03f)
                moveToRelative(dx = 19.97f, dy = -4.98f)
                lineToRelative(dx = 0.03f, dy = 1.0f)
                verticalLineToRelative(dy = 6.0f)
                curveToRelative(dx1 = 0.0f, dy1 = 5.0f, dx2 = -2.0f, dy2 = 7.0f, dx3 = -7.0f, dy3 = 7.0f)
                horizontalLineTo(x = 9.0f)
                arcToRelative(a = 13.0f, b = 13.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -2.04f, dy1 = -0.13f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
                ...
                curveTo(x1 = 6.9f, y1 = 6.0f, x2 = 6.0f, y2 = 6.9f, x3 = 6.0f, y3 = 8.0f)
                ...
                moveToRelative(dx = 9.43f, dy = -5.55f)
                ...
                arcToRelative(a = 2.0f, b = 2.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 2.82f, dy1 = 0.0f)
                lineTo(x = 22.0f, y = 13.05f)
            }
