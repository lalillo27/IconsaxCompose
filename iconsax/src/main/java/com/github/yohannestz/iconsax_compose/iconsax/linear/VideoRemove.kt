...
val VideoRemove: ImageVector
    get() {
        val current = _videoRemove
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.VideoRemove",
            ...
            path(
                ...
                arcToRelative(a = 4.5f, b = 4.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -6.57f, dy1 = -0.14f)
                arcToRelative(a = 4.5f, b = 4.5f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.62f, dy1 = 5.46f)
                arcToRelative(a = 4.0f, b = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.86f, dy1 = 1.02f)
            ...
            path(
                ...
                lineToRelative(dx = -0.16f, dy = -0.14f)
                arcToRelative(a = 4.0f, b = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.86f, dy1 = -1.02f)
                ...
                moveToRelative(dx = -3.3f, dy = 1.18f)
                lineToRelative(dx = -2.38f, dy = -2.38f)
                moveToRelative(dx = 2.36f, dy = 0.02f)
                lineTo(x = 17.3f, y = 19.7f)
            }
        }.build().also { _videoRemove = it }
    }
