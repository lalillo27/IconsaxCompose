...
val MessageRemove: ImageVector
    get() {
        val current = _messageRemove
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.MessageRemove",
            ...
            path(
                ...
                curveToRelative(dx1 = -0.2f, dy1 = 0.2f, dx2 = -0.48f, dy2 = 0.28f, dx3 = -0.74f, dy3 = 0.2f)
                ...
                arcToRelative(a = 4.76f, b = 4.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 4.75f, dy1 = 4.75f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
                ...
                arcToRelative(a = 4.7f, b = 4.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -3.17f, dy1 = -1.23f)
                arcToRelative(a = 4.7f, b = 4.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -0.24f, dy1 = -6.83f)
                arcTo(horizontalEllipseRadius = 4.7f, verticalEllipseRadius = 4.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 5.0f, y1 = 12.75f)
                arcToRelative(a = 4.76f, b = 4.76f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 4.6f, dy1 = 5.87f)
                arcTo(horizontalEllipseRadius = 4.7f, verticalEllipseRadius = 4.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 5.0f, y1 = 22.25f)
                ...
                arcToRelative(a = 3.0f, b = 3.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.61f, dy1 = 0.74f)
                arcToRelative(a = 3.22f, b = 3.22f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 4.95f, dy1 = -0.72f)
                arcToRelative(a = 3.0f, b = 3.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.37f, dy1 = -0.91f)
                arcToRelative(a = 3.24f, b = 3.24f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.74f, dy1 = -2.94f)
                arcTo(horizontalEllipseRadius = 3.2f, verticalEllipseRadius = 3.2f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 5.0f, y1 = 14.25f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
                moveTo(x = 6.07f, y = 19.3f)
            ...
            path(
                ...
                moveTo(x = 3.93f, y = 19.32f)
                arcTo(horizontalEllipseRadius = 0.7f, verticalEllipseRadius = 0.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 3.4f, y1 = 19.1f)
                arcToRelative(a = 0.75f, b = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = -1.06f)
                ...
                moveToRelative(dx = 11.57f, dy = -8.07f)
