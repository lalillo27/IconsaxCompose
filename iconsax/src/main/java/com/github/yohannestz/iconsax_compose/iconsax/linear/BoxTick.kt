    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 3.99f, b = 3.99f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = true, dx1 = -6.03f, dy1 = -5.05f)
                ...
                arcTo(horizontalEllipseRadius = 4.0f, verticalEllipseRadius = 4.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 23.0f, y1 = 17.91f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
