    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 12.0f, y = 5.2f)
                lineToRelative(dx = -2.5f, dy = 8.0f)
                lineToRelative(dx = 5.0f, dy = -2.4f)
                close()
            }
            path(
                stroke = SolidColor(Color(0xFF17191C)),
                ...
                moveTo(x = 14.1f, y = 11.0f)
                lineToRelative(dx = 3.9f, dy = 1.2f)
                lineToRelative(dx = -4.5f, dy = 2.6f)
                lineToRelative(dx = -0.4f, dy = -0.2f)
                lineTo(x = 6.0f, y = 12.2f)
                lineToRelative(dx = 4.0f, dy = -2.0f)
                moveToRelative(dx = 3.0f, dy = 5.0f)
                lineToRelative(dx = -1.0f, dy = 3.0f)
                lineToRelative(dx = -2.5f, dy = -4.6f)
            }
            path(
                stroke = SolidColor(Color(0xFF17191C)),
                strokeLineCap = StrokeCap.Round,
