...
val SmsTracking: ImageVector
    get() {
        val current = _smsTracking
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.SmsTracking",
            ...
            path(
                ...
                reflectiveCurveTo(x1 = 6.59f, y1 = 19.75f, x2 = 7.0f, y2 = 19.75f)
                ...
                reflectiveCurveTo(x1 = 1.25f, y1 = 8.91f, x2 = 1.25f, y2 = 8.5f)
            ...
            path(
                ...
                moveToRelative(dx = -4.0f, dy = 4.38f)
                horizontalLineTo(x = 2.0f)
                curveToRelative(dx1 = -0.41f, dy1 = 0.0f, dx2 = -0.75f, dy2 = -0.34f, dx3 = -0.75f, dy3 = -0.75f)
                reflectiveCurveTo(x1 = 1.59f, y1 = 15.75f, x2 = 2.0f, y2 = 15.75f)
                ...
                horizontalLineTo(x = 2.0f)
                curveToRelative(dx1 = -0.41f, dy1 = 0.0f, dx2 = -0.75f, dy2 = -0.34f, dx3 = -0.75f, dy3 = -0.75f)
                reflectiveCurveTo(x1 = 1.59f, y1 = 11.75f, x2 = 2.0f, y2 = 11.75f)
                horizontalLineToRelative(dx = 3.0f)
                curveToRelative(dx1 = 0.41f, dy1 = 0.0f, dx2 = 0.75f, dy2 = 0.34f, dx3 = 0.75f, dy3 = 0.75f)
                reflectiveCurveTo(x1 = 5.41f, y1 = 13.25f, x2 = 5.0f, y2 = 13.25f)
            }
        }.build().also { _smsTracking = it }
    }
