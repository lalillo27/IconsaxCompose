    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(dx = 0.53f, dy = -2.31f)
                arcTo(horizontalEllipseRadius = 1.7f, verticalEllipseRadius = 1.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 7.0f, y1 = 16.25f)
                lineToRelative(dx = -1.86f, dy = -1.86f)
                curveToRelative(dx1 = -1.1f, dy1 = -1.1f, dx2 = -0.74f, dy2 = -2.21f, dx3 = 0.79f, dy3 = -2.46f)
                lineToRelative(dx = 2.39f, dy = -0.4f)
