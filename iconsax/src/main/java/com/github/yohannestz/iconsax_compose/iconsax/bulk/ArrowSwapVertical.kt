    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 10.24f, y = 6.25f)
                arcTo(horizontalEllipseRadius = 0.75f, verticalEllipseRadius = 0.75f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 9.49f, y1 = 7.0f)
                verticalLineToRelative(dy = 8.19f)
                ...
                arcToRelative(a = 0.77f, b = 0.77f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.76f, dy1 = -0.75f)
                moveToRelative(dx = 7.0f, dy = 3.17f)
                lineToRelative(dx = -2.95f, dy = -2.95f)
                ...
                arcTo(horizontalEllipseRadius = 0.8f, verticalEllipseRadius = 0.8f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 13.01f, y1 = 7.0f)
