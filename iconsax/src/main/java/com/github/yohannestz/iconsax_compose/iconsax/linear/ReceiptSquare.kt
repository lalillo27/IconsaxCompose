    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 1.04f, b = 1.04f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.64f, dy1 = -0.09f)
                ...
                curveTo(x1 = 7.0f, y1 = 17.27f, x2 = 7.86f, y2 = 17.64f, x3 = 8.9f, y3 = 16.53f)
            }
