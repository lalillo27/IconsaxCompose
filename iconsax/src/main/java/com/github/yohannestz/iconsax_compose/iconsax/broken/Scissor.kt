    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 5.5f, y = 3.0f)
                arcTo(horizontalEllipseRadius = 3.5f, verticalEllipseRadius = 3.5f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = true, x1 = 2.0f, y1 = 6.5f)
                moveTo(x = 5.5f, y = 21.0f)
