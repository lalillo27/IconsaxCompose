    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 6.0f, b = 6.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.12f, dy1 = 1.28f)
            ...
            path(
                ...
                curveToRelative(dx1 = 1.9f, dy1 = 0.39f, dx2 = 3.12f, dy2 = 1.73f, dx3 = 3.12f, dy3 = 4.28f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
                ...
                moveTo(x = 13.14f, y = 10.5f)
                arcToRelative(a = 2.64f, b = 2.64f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = false, dx1 = -2.64f, dy1 = 2.64f)
