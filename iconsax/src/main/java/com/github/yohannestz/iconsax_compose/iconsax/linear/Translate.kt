    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                lineToRelative(dx = -2.14f, dy = 4.27f)
                moveToRelative(dx = 0.39f, dy = -0.76f)
            ...
            path(
                ...
                moveTo(x = 16.92f, y = 22.0f)
                arcToRelative(a = 5.08f, b = 5.08f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = true, dx1 = 0.0f, dy1 = -10.16f)
                arcToRelative(a = 5.08f, b = 5.08f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.0f, dy1 = 10.16f)
                moveTo(x = 5.02f, y = 2.0f)
                horizontalLineToRelative(dx = 3.92f)
                quadToRelative(dx1 = 3.1f, dy1 = 0.0f, dx2 = 3.02f, dy2 = 3.02f)
                verticalLineToRelative(dy = 3.92f)
                quadToRelative(dx1 = 0.08f, dy1 = 3.1f, dx2 = -3.02f, dy2 = 3.02f)
                horizontalLineTo(x = 5.02f)
                quadTo(x1 = 1.99f, y1 = 12.03f, x2 = 2.0f, y2 = 8.93f)
                verticalLineTo(y = 5.01f)
                quadTo(x1 = 2.0f, y1 = 2.0f, x2 = 5.02f, y2 = 2.0f)
                moveToRelative(dx = 3.99f, dy = 3.85f)
            ...
            path(
                ...
                moveTo(x = 7.99f, y = 5.84f)
                arcToRelative(a = 3.1f, b = 3.1f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -3.05f, dy1 = 3.17f)
            }
            path(
                stroke = SolidColor(Color(0xFF292D32)),
                strokeLineCap = StrokeCap.Round,
