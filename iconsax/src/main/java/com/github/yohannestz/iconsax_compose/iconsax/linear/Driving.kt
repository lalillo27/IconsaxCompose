    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = -0.78f, dy1 = 0.0f, dx2 = -0.89f, dy2 = -0.33f, dx3 = -1.03f, dy3 = -0.75f)
                ...
                curveToRelative(dx1 = -1.04f, dy1 = 0.0f, dx2 = -1.2f, dy2 = 0.45f, dx3 = -1.38f, dy3 = 0.99f)
                lineToRelative(dx = -0.15f, dy = 0.43f)
                curveToRelative(dx1 = -0.14f, dy1 = 0.41f, dx2 = -0.25f, dy2 = 0.75f, dx3 = -1.03f, dy3 = 0.75f)
                horizontalLineTo(x = 6.22f)
                arcToRelative(a = 1.46f, b = 1.46f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = -1.47f, dy1 = -1.58f)
                lineTo(x = 5.16f, y = 9.9f)
                curveToRelative(dx1 = 0.1f, dy1 = -1.09f, dx2 = 0.31f, dy2 = -1.98f, dx3 = 2.21f, dy3 = -1.98f)
                horizontalLineToRelative(dx = 9.25f)
                curveToRelative(dx1 = 1.9f, dy1 = 0.0f, dx2 = 2.11f, dy2 = 0.89f, dx3 = 2.21f, dy3 = 1.98f)
                close()
