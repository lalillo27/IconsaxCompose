    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = -9.0f, dy = 4.89f)
            ...
            path(
                ...
                lineTo(x = 15.5f, y = 6.22f)
                arcToRelative(a = 1.0f, b = 1.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.3f, dy1 = 0.6f)
                lineTo(x = 15.0f, y = 8.23f)
                curveToRelative(dx1 = -0.07f, dy1 = 0.5f, dx2 = 0.28f, dy2 = 0.85f, dx3 = 0.78f, dy3 = 0.78f)
                lineToRelative(dx = 1.39f, dy = -0.2f)
                arcToRelative(a = 1.3f, b = 1.3f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 0.6f, dy1 = -0.3f)
                lineToRelative(dx = 3.64f, dy = -3.63f)
