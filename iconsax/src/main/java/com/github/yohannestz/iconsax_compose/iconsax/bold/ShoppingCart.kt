    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 2.7f, b = 2.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.92f, dy1 = -0.84f)
                ...
                moveToRelative(dx = 15.67f, dy = 4.81f)
                ...
                arcTo(horizontalEllipseRadius = 2.9f, verticalEllipseRadius = 2.9f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 6.92f, y1 = 17.0f)
