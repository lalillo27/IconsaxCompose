...
val CloudDrizzle: ImageVector
    get() {
        val current = _cloudDrizzle
        if (current != null) return current

        return ImageVector.Builder(
            name = "com.github.yohannestz.iconsax_compose.iconsax.IconsaxTheme.CloudDrizzle",
