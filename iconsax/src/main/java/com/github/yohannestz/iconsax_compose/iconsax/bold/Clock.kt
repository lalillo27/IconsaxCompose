    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(dx = 4.35f, dy = 13.57f)
                ...
                verticalLineToRelative(dy = 4.1f)
                curveToRelative(dx1 = 0.0f, dy1 = 0.36f, dx2 = 0.3f, dy2 = 0.89f, dx3 = 0.61f, dy3 = 1.07f)
                lineToRelative(dx = 3.1f, dy = 1.85f)
                arcToRelative(a = 0.74f, b = 0.74f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 0.26f, dy1 = 1.03f)
            }
