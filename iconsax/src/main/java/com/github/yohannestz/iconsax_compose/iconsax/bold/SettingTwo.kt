    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 20.1f, y = 9.22f)
                curveToRelative(dx1 = -1.81f, dy1 = 0.0f, dx2 = -2.55f, dy2 = -1.28f, dx3 = -1.65f, dy3 = -2.85f)
                arcToRelative(a = 1.9f, b = 1.9f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.7f, dy1 = -2.59f)
                lineTo(x = 16.02f, y = 2.8f)
                ...
                lineToRelative(dx = -0.11f, dy = -0.2f)
                arcToRelative(a = 1.64f, b = 1.64f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -2.26f, dy1 = -0.6f)
                ...
                arcToRelative(a = 1.9f, b = 1.9f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 1.9f, dy1 = -1.9f)
                verticalLineToRelative(dy = -1.76f)
                arcToRelative(a = 1.9f, b = 1.9f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -1.91f, dy1 = -1.9f)
