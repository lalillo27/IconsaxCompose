    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(dx1 = 0.41f, dy1 = 0.0f, dx2 = 0.75f, dy2 = 0.34f, dx3 = 0.75f, dy3 = 0.75f)
                reflectiveCurveToRelative(dx1 = -0.34f, dy1 = 0.75f, dx2 = -0.75f, dy2 = 0.75f)
                moveToRelative(dx = -7.35f, dy = -8.13f)
                horizontalLineToRelative(dx = -0.26f)
                arcTo(horizontalEllipseRadius = 5.17f, verticalEllipseRadius = 5.17f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, x1 = 6.8f, y1 = 6.44f)
                arcToRelative(a = 5.2f, b = 5.2f, theta = 0.0f, isMoreThanHalf = true, isPositiveArc = true, dx1 = 5.38f, dy1 = 5.18f)
                close()
                moveToRelative(dx = -0.16f, dy = -8.87f)
                arcTo(horizontalEllipseRadius = 3.7f, verticalEllipseRadius = 3.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, x1 = 8.3f, y1 = 6.44f)
                arcToRelative(a = 3.66f, b = 3.66f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 3.87f, dy1 = 3.68f)
                arcToRelative(a = 3.7f, b = 3.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = 3.51f, dy1 = -3.68f)
                arcToRelative(a = 3.7f, b = 3.7f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -3.69f, dy1 = -3.69f)
            }
            path(
                fill = SolidColor(Color(0xFF292D32)),
            ) {
