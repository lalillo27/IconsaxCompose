    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(a = 1.9f, b = 1.9f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = false, dx1 = -0.44f, dy1 = 1.53f)
                lineTo(x = 18.95f, y = 19.0f)
                ...
                lineToRelative(dx = -2.93f, dy = 1.74f)
                curveToRelative(dx1 = -1.11f, dy1 = 0.65f, dx2 = -2.06f, dy2 = 0.76f, dx3 = -2.67f, dy3 = 0.3f)
                lineToRelative(dx = -0.11f, dy = -0.1f)
                lineTo(x = 18.07f, y = 8.94f)
                arcToRelative(a = 2.0f, b = 2.0f, theta = 0.0f, isMoreThanHalf = false, isPositiveArc = true, dx1 = 1.75f, dy1 = -0.56f)
                lineToRelative(dx = 0.15f, dy = 0.03f)
                curveToRelative(dx1 = 1.06f, dy1 = 0.18f, dx2 = 1.77f, dy2 = 0.66f, dx3 = 2.0f, dy3 = 1.36f)
                reflectiveCurveToRelative(dx1 = -0.08f, dy1 = 1.5f, dx2 = -0.84f, dy2 = 2.27f)
                close()
