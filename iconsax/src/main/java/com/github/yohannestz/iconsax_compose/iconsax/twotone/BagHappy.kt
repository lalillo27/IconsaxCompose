    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                moveTo(x = 8.5f, y = 14.25f)
                curveToRelative(dx1 = 0.0f, dy1 = 1.92f, dx2 = 1.58f, dy2 = 3.5f, dx3 = 3.5f, dy3 = 3.5f)
                reflectiveCurveToRelative(dx1 = 3.5f, dy1 = -1.58f, dx2 = 3.5f, dy2 = -3.5f)
